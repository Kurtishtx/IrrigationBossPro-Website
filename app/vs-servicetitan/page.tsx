    ...
    <>
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .compare-table th.sbp-col { background: rgba(132,204,22,.08); color: var(--orange); }
      ...
      <div className="hero">
        ...
        <h1>ServiceTitan Is Built for HVAC and Plumbing.<br /><span>IrrigationBossPro Is Built for Irrigation.</span></h1>
        <p>ServiceTitan is an enterprise platform designed for large HVAC, plumbing, and electrical companies. It&apos;s powerful — and it&apos;s priced and scoped for that world. If you run a sprinkler install or irrigation repair operation, you don&apos;t need ServiceTitan. You need software that was built around the way irrigation businesses actually work.</p>
        ...
        <div className="hero-stats">
          ...
          <div><div className="hero-stat-val">Built</div><div className="hero-stat-lbl">For Sprinkler Crews — Not HVAC</div></div>
      ...
      <section>
        <div className="centered" style={{maxWidth:'900px', margin:'0 auto'}}>
          ...
          <h2 className="section-title">IrrigationBossPro vs ServiceTitan</h2>
          <p className="section-sub">ServiceTitan is built for enterprise HVAC. IrrigationBossPro is built for irrigation and sprinkler businesses.</p>
        </div>
          ...
          <table className="compare-table">
            <thead>
              <tr>
                ...
                <th className="sbp-col" style={{width:'25%'}}>IrrigationBossPro</th>
                <th style={{width:'25%'}}>ServiceTitan</th>
              </tr>
            </thead>
            <tbody>
              <tr><td className="feature-name">Built Specifically for Irrigation &amp; Sprinkler Work</td><td className="sbp-col"><span className="chk">✓</span></td><td><span className="crs">✗</span></td></tr>
              ...
              <tr><td className="feature-name">Parts &amp; Materials (Heads, Valves, Controllers)</td><td className="sbp-col"><span className="chk">✓</span></td><td><span className="crs">✗</span></td></tr>
              ...
              <tr><td className="feature-name">Recurring Seasonal Service (Winterization / Start-Up)</td><td className="sbp-col"><span className="chk">✓</span></td><td><span className="prt">Generic contracts</span></td></tr>
      ...
      <div className="premium-band">
        <h2>ServiceTitan Was Built for $5M+ HVAC Companies.<br /><span>IrrigationBossPro Was Built for Sprinkler Crews.</span></h2>
        <p>ServiceTitan is one of the most powerful field service platforms in the world. It&apos;s also one of the most expensive, most complex, and most overkill tools you could choose for an irrigation or sprinkler repair business. You&apos;d spend 90 days implementing it, pay $300–$500+/month, and still be missing features built specifically for irrigation businesses. IrrigationBossPro is $129, set up in an afternoon, and built around how your routes actually work.</p>
        <div className="premium-grid">
          <div className="premium-card"><div className="premium-card-icon">📋</div><h4>Irrigation-Specific Features</h4><p>Sq ft waiting lists, parts &amp; materials for heads, valves and controllers, lasso route selector, recurring seasonal service tracking — features built around how sprinkler installs and repairs actually run. ServiceTitan doesn&apos;t have any of these.</p></div>
          <div className="premium-card"><div className="premium-card-icon">⚡</div><h4>Up in a Day, Not 90</h4><p>ServiceTitan implementations take months. You&apos;ll need an onboarding team, configuration calls, and a lot of patience. IrrigationBossPro is designed for owners who want to be operational today — not next quarter.</p></div>
          <div className="premium-card"><div className="premium-card-icon">💰</div><h4>$129 vs $300–500+</h4><p>ServiceTitan pricing is custom, but independent estimates consistently put it at $300–$500+ per month for small operations — before add-ons. IrrigationBossPro is $129/month. No negotiation, no annual contract, no surprise invoices.</p></div>
          <div className="premium-card"><div className="premium-card-icon">🗺️</div><h4>Lasso Route Selector</h4><p>Draw a circle on the map, instantly see every stop inside with a service due — sq ft, service type, all calculated. ServiceTitan has route optimization but nothing like the Lasso geographic selector built for sprinkler route density.</p></div>
          <div className="premium-card"><div className="premium-card-icon">🔧</div><h4>Parts &amp; Materials Built In</h4><p>Track heads, valves, controllers, pipe and backflow devices on every estimate and job. Add line-item parts in seconds. ServiceTitan tracks jobs, but nothing like a parts list built for sprinkler installs and valve repairs.</p></div>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="highlight-row">
          <div className="highlight-text">
            ...
            <h2>ServiceTitan Is an Enterprise Platform. You&apos;re an Irrigation Business.</h2>
            <p>ServiceTitan serves thousands of companies, but its core use case is large residential service businesses — HVAC, plumbing, electrical. Irrigation and sprinkler work aren&apos;t really in the design. You&apos;d be paying for a tool built for a completely different operation.</p>
            <ul className="check-list">
              <li>No sq ft waiting list — ServiceTitan doesn&apos;t understand the sprinkler model</li>
              <li>No lasso selector — geographic circle scheduling doesn&apos;t exist in ST</li>
              <li>No parts &amp; materials built for heads, valves and controllers</li>
              ...
              <li>Built for HVAC, plumbing, electrical — not sprinkler routes</li>
            </ul>
          </div>
          <div className="highlight-visual">
            ...
            <div className="mock-item">
              ...
              <div><div className="mock-label">IrrigationBossPro</div><div className="mock-sub">Every feature — built for sprinkler routes</div></div>
            ...
            <div style={{marginTop:'16px', background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'14px 16px'}}>
              <div style={{color:'var(--orange)', fontSize:'13px', fontWeight:700, marginBottom:'8px'}}>IrrigationBossPro also includes things ST doesn&apos;t:</div>
              <div style={{color:'rgba(255,255,255,.6)', fontSize:'12px', lineHeight:2}}>✓ Sq Ft Waiting List by Service Type<br />✓ Lasso Circle Map Route Selector<br />✓ Parts &amp; Materials — Heads, Valves, Controllers<br />✓ Seasonal Service &amp; Renewal Tracking<br />✓ Set up in one afternoon — no consultants</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="lasso" className="dark-section">
        <div className="highlight-row">
          <div className="highlight-text">
            ...
            <p style={{color:'rgba(255,255,255,.65)'}}>Draw a circle on your map and IrrigationBossPro shows you every property inside with a service due — total stops, sq ft, service types — before you schedule a single stop. No comparable feature exists in ServiceTitan. It&apos;s not route optimization. It&apos;s a geographic sprinkler route builder built specifically for recurring seasonal service schedules.</p>
            <ul className="check-list" style={{marginTop:'20px'}}>
              ...
              <li style={{color:'rgba(255,255,255,.75)'}}>Built specifically for recurring sprinkler route scheduling</li>
          ...
          <div className="highlight-visual">
            ...
            <div className="stat-grid">
              ...
              <div className="stat-cell full"><div className="stat-val">Repairs · 8 &nbsp;|&nbsp; Winterization · 6 &nbsp;|&nbsp; Backflow · 5</div><div className="stat-lbl">Breakdown by Service Type</div></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto 56px'}}>
          ...
          <p className="section-sub" style={{maxWidth:'720px'}}>ServiceTitan implementations take months, require training, and need ongoing support. IrrigationBossPro is designed for irrigation business owners who want to be running today — not next quarter after a paid onboarding engagement.</p>
        </div>
        <div className="simple-grid">
          <div className="simple-card"><div className="simple-num">01</div><h3>No Onboarding Team Required</h3><p>IrrigationBossPro is designed to be self-serve from day one. Add your services, import your clients and properties, connect your payment processor, and you&apos;re scheduling. No implementation consultant, no 90-day setup timeline.</p></div>
          <div className="simple-card"><div className="simple-num">02</div><h3>Pricing You Can Plan Around</h3><p>$129/month. No custom quotes, no sales calls, no contract negotiations. ServiceTitan won&apos;t even give you pricing without a demo — because their pricing is based on your revenue. IrrigationBossPro is $129. Always.</p></div>
          <div className="simple-card"><div className="simple-num">03</div><h3>Crews Learn It Fast</h3><p>Your crew picks up the mobile app in minutes. No training program, no certification, no thick manual. The crew app shows today&apos;s stops, property notes, and a complete button. That&apos;s it.</p></div>
          <div className="simple-card"><div className="simple-num">04</div><h3>Cancel Anytime — No Lock-In</h3><p>No annual contract required. Month to month from day one. ServiceTitan requires annual agreements that lock you in regardless of how the software performs. IrrigationBossPro earns your business every month.</p></div>
        </div>
      </section>
      ...
      <section>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto'}}>
          ...
          <p className="section-sub">ServiceTitan won&apos;t tell you their price until you sit through a demo. IrrigationBossPro is $129. Right here, right now.</p>
        </div>
        <div style={{maxWidth:'520px', margin:'0 auto'}}>
          <div className="price-card featured" style={{width:'100%'}}>
            ...
            <ul className="price-features">
              ...
              <li>Parts &amp; Materials — Heads, Valves, Controllers</li>
              ...
              <li>Seasonal Service &amp; Renewal Tracking</li>
      ...
      <div className="cta-band">
        <h2>You Don&apos;t Need an Enterprise Platform.<br />You Need Software Built for Sprinkler Routes.</h2>
        <p>Try IrrigationBossPro free for 14 days. Set up in an afternoon. $129/month — no sales call required.</p>
        <div className="hero-btns">

  ...
  return (
    <>
      ...
      <div className="hero">
        ...
        <h1>ServiceTitan Is Built for HVAC and Plumbing.<br /><span>IrrigationBossPro Is Built for Lawn Care.</span></h1>
      ...
      <section>
        <div className="centered" style={{maxWidth:'900px', margin:'0 auto'}}>
          ...
          <p className="section-sub">ServiceTitan is built for enterprise HVAC. IrrigationBossPro is built for lawn care and pest control.</p>
        </div>
      ...
      <div className="premium-band">
        <h2>ServiceTitan Was Built for $5M+ HVAC Companies.<br /><span>IrrigationBossPro Was Built for Spray Routes.</span></h2>
        <p>ServiceTitan is one of the most powerful field service platforms in the world. It&apos;s also one of the most expensive, most complex, and most overkill tools you could choose for a lawn care or pest control business. You&apos;d spend 90 days implementing it, pay $300–$500+/month, and still be missing features built specifically for spray businesses. IrrigationBossPro is $129, set up in an afternoon, and built around how your routes actually work.</p>
        ...
        <div className="highlight-row">
          ...
          <div className="highlight-visual">
            ...
            <div className="mock-item">
              ...
              <div><div className="mock-label">IrrigationBossPro</div><div className="mock-sub">Every feature — built for spray routes</div></div>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto 56px'}}>
          ...
          <p className="section-sub" style={{maxWidth:'720px'}}>ServiceTitan implementations take months, require training, and need ongoing support. IrrigationBossPro is designed for spray business owners who want to be running today — not next quarter after a paid onboarding engagement.</p>
        </div>

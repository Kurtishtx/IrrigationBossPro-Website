    ...
    <>
      ...
      <div style={{background:'var(--purple-dark)', padding:'0 40px 60px', textAlign:'center'}}>
        <img
          ...
          fetchPriority="high"
          decoding="async"
          alt="IrrigationBossPro lawn care scheduling software showing route map, waiting list by square footage, and mobile app for technicians"
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto 48px'}}>
          ...
          <p className="section-sub">IrrigationBossPro handles the scheduling, routing, compliance logging, and customer SMS alerts for every type of lawn care program your company runs — all in one place, all in one price.</p>
        </div>
        <div className="audience-grid">
          <div className="audience-card">
            <div className="audience-tag">Fertilizer Programs</div>
            <h3>5-Round &amp; 6-Round Fertilizer Schedules</h3>
            <p>Set up your fertilizer rounds once. IrrigationBossPro auto-schedules every subsequent round when the previous one is completed. Track sq ft or linear ft per property. Log EPA reg numbers and rates at the door on every visit.</p>
          </div>
          <div className="audience-card">
      ...
      <section>
        <div className="highlight-row">
          <div className="highlight-text">
            ...
            <p>Before you build a single route, IrrigationBossPro shows you a waiting list of every lawn care treatment due — grouped by service type, with total sq ft or linear ft and total stops per service. Lawn fertilizer, weed control, lawn insect, grub control, aeration — each on its own row with totals for the day.</p>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="highlight-row reverse">
          <div className="highlight-text">
            ...
            <p>Open Lasso on the map, draw a circle around any neighborhood or service zone, and IrrigationBossPro instantly shows you every property with a lawn care treatment due inside that boundary. Service type, sq ft or linear ft, and route revenue — all of it before you commit to building the route.</p>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="highlight-row reverse">
          <div className="highlight-text">
            ...
            <p>IrrigationBossPro sends day-before service reminders, on-the-way alerts when your tech starts driving to the property, and service complete notifications with re-entry intervals — all automatically, on every single lawn care visit.</p>
      ...
      <section>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto 64px'}}>
          ...
          <p className="section-sub">IrrigationBossPro is designed so that scheduling a full day of lawn care routes takes minutes, not the first two hours of your morning. For a step-by-step look at how top companies do it, read <a href="/blogs/how-to-build-lawn-care-routes-fast" style={{color:'var(--orange)', fontWeight:600}}>How to Build Lawn Care Routes in Under 30 Minutes Every Morning</a>.</p>
        </div>
      ...
      <div className="premium-band">
        ...
        <p>IrrigationBossPro isn&#39;t a generic scheduling app adapted for lawn care. The waiting list, Lasso route builder, compliance logging, auto-rescheduling, and automated SMS alerts are all built specifically for companies that apply chemical treatments on recurring lawn care programs.</p>
        <div className="premium-grid">
          ...
          <div className="premium-card"><div className="premium-card-icon">👥</div><h4>Unlimited Technicians</h4><p>Run 1 truck or 10. IrrigationBossPro never charges per user — every tech in your company is included at $129/month.</p></div>
        </div>
      </div>
      ...
      <section style={{background:'#fff'}}>
        <div style={{maxWidth:'860px', margin:'0 auto', padding:'80px 40px'}}>
          ...
          {[
            {q:'Does IrrigationBossPro work for lawn care scheduling?', a:'Yes. IrrigationBossPro handles recurring lawn care program scheduling — pre-emergent, fertilizer, post-emergent, weed control — with a waiting list dispatch board, circle-map route building, sq ft pricing, and automated SMS for every visit.'},
            ...
            {q:'Can I schedule multiple rounds of a recurring program?', a:'Yes. You can set up recurring programs with any number of rounds. IrrigationBossPro tracks which round each customer is on, when they\'re due, and how many treatments remain. When a round is completed, the next goes back on the waiting list automatically.'},
            {q:'Does it send automatic reminders to lawn care customers?', a:'Yes. IrrigationBossPro sends automated SMS alerts for every visit: day-before reminders, on-the-way notifications, and completion messages. Alerts are configured once and fire automatically for every service. 500 outbound SMS/month are included at no extra charge.'},
            {q:'Can I price lawn care services by square footage?', a:'Yes. IrrigationBossPro stores sq ft per property and calculates service pricing based on per-sq-ft rates you set. Pricing appears automatically on the waiting list and in estimates — no manual calculation per stop.'},
            {q:'How much does IrrigationBossPro cost for a lawn care business?', a:'$129/month, flat. No per-user fees, no SMS add-ons, no extra charge for chemical logs or route building. Every feature is included. 14-day free trial, no credit card required.'},
          ].map(({q, a}, i, arr) => (
          ...
          <p style={{marginTop:'40px', color:'var(--muted)', fontSize:'15px', lineHeight:1.7}}>IrrigationBossPro is lawn care scheduling software built for route-based spray businesses — <a href="/" style={{color:'var(--orange)', fontWeight:600}}>see the full platform overview</a> to learn what's included.</p>
        </div>
      </section>

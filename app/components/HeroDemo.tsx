...
const DEMOS: Record<Key, Demo> = {
  business: {
    ...
    url: 'https://my.irrigationbosspro.com/demo.html?v=6',
    label: '🖥️ Desktop version', kind: 'desktop',
    cap: 'The full software you run everything from — zone records, service scheduling, crew dispatch and billing.',
  },
  client: {

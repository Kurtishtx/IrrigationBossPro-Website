    ...
    <>
      ...
      <div style={{background:'var(--purple-dark)', padding:'0 40px 60px', textAlign:'center'}}>
        <img
          ...
          fetchPriority="high"
          decoding="async"
          alt="IrrigationBossPro weed control software showing pre-emergent and post-emergent scheduling, circle-map routing, and mobile app for technicians"
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto 48px'}}>
          ...
          <p className="section-sub">IrrigationBossPro handles the scheduling, routing, compliance logging, and re-entry SMS for every weed control program your lawn care company runs — alongside fertilizer, insect, and any other service you offer. One platform. One price.</p>
        </div>
        <div className="audience-grid">
          <div className="audience-card">
            <div className="audience-tag">Pre-Emergent Programs</div>
            <h3>Seasonal Pre-Emergent Scheduling with Timing Windows</h3>
            <p>Pre-emergent rounds need to hit the right soil temperature window — IrrigationBossPro lets you schedule them at your target seasonal date and shows them on the waiting list when they&apos;re due. Early spring and fall pre-emergent rounds tracked separately with their own compliance logs and re-entry SMS.</p>
          </div>
          <div className="audience-card">
            <div className="audience-tag">Post-Emergent Programs</div>
            <h3>Post-Emergent Weed Control on Auto-Reschedule</h3>
            <p>Post-emergent rounds reschedule automatically at your set interval when the previous round is completed. 4-week, 6-week, or 8-week cycles — IrrigationBossPro manages the timing between rounds so your team never manually reschedules a weed control visit between applications.</p>
          </div>
          <div className="audience-card">
          ...
          <div className="audience-card">
            ...
            <p>Run weed control and fertilizer on the same route? IrrigationBossPro lets you mix service types on any Lasso route or keep them on separate routes. All services share one waiting list, one map, and one dispatch flow — your tech sees all services for each stop in one place on their phone.</p>
          </div>
        </div>
      </section>
      ...
      <section>
        <div className="highlight-row">
          <div className="highlight-text">
            ...
            <p>IrrigationBossPro handles the timing differences between pre-emergent and post-emergent weed control automatically. Pre-emergent rounds appear on the waiting list when they hit your set seasonal date — spring pre-emergent at the right soil temp window, fall pre-emergent before the window closes.</p>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="highlight-row reverse">
          <div className="highlight-text">
            ...
            <p>Weed control products often have specific re-entry interval requirements that vary by product formulation. IrrigationBossPro captures the re-entry interval from the application log and uses it to trigger the right re-entry SMS to the customer automatically.</p>
            <ul className="check-list">
      ...
      <section>
        <div className="highlight-row">
          <div className="highlight-text">
            ...
            <p>When the compliance log is saved after a weed control application, IrrigationBossPro uses the re-entry interval from the log to build the right customer SMS — &quot;please stay off the lawn for 4 hours&quot; or &quot;24 hours&quot; depending on what your tech actually applied. The text goes out automatically.</p>
            <p>Pre-emergent and post-emergent applications often have different re-entry intervals. IrrigationBossPro captures the correct interval from the application log and sends the matching SMS — not a generic template that&apos;s wrong for half your products.</p>
            <ul className="check-list">
          ...
          <div className="highlight-visual">
            <div style={{color:'rgba(255,255,255,.45)', fontSize:'10px', textTransform:'uppercase', letterSpacing:'.8px', marginBottom:'14px'}}>Weed Control SMS Thread — Sent Automatically by IrrigationBossPro</div>
      ...
      <div className="premium-band">
        ...
        <p>IrrigationBossPro isn&apos;t a generic scheduling app with a weed control tag. Pre-emergent timing windows, post-emergent auto-rescheduling, EPA compliance logs, re-entry interval SMS, and Lasso routing are built specifically for companies running recurring weed control programs on residential and commercial lawns.</p>
      ...
      <section style={{background:'#fff'}}>
        <div style={{maxWidth:'860px', margin:'0 auto', padding:'80px 40px'}}>
          ...
          {[
            {q:'Does IrrigationBossPro work for weed control businesses?', a:'Yes. IrrigationBossPro manages pre-emergent and post-emergent scheduling, sq ft-based routing, chemical compliance logs, and automated SMS — including re-entry interval messages. It handles recurring weed control programs across a full season with automatic rescheduling after each treatment.'},
            {q:'Can I schedule pre-emergent and post-emergent treatments separately?', a:'Yes. IrrigationBossPro manages multiple service types simultaneously. Pre-emergent and post-emergent appear as separate entries on the waiting list, with independent intervals, pricing, and chemical product assignments. You can route one without affecting the other.'},
            ...
            {q:'Can IrrigationBossPro manage weed control alongside lawn care or fertilizer?', a:'Yes. IrrigationBossPro handles lawn care, fertilizer, pest control, and weed control from one account. The waiting list filters by service type, and SMS alerts are configured independently per service — so weed control customers get weed control-specific messaging.'},
            ...
            {q:'How much does IrrigationBossPro cost for a weed control business?', a:'$129/month, flat. All features included. No per-user fees, no SMS add-ons, no extra charge for compliance logs. 14-day free trial, no credit card required.'},
          ].map(({q, a}, i, arr) => (
          ...
          <p style={{marginTop:'40px', color:'var(--muted)', fontSize:'15px', lineHeight:1.7}}>IrrigationBossPro handles weed control alongside lawn care, fertilizer, pest control, and mosquito spray — all from one platform — <a href="/" style={{color:'var(--orange)', fontWeight:600}}>see the full platform overview</a>.</p>
        </div>
      </section>

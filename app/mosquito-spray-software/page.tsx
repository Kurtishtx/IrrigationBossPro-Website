    ...
    <>
      ...
      <div style={{background:'var(--purple-dark)', padding:'0 40px 60px', textAlign:'center'}}>
        <img
          ...
          fetchPriority="high"
          decoding="async"
          alt="IrrigationBossPro mosquito spray software showing the waiting list, circle-map route builder, and mobile dispatch on laptop and phone"
      ...
      <section>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto'}}>
          ...
          <p className="section-sub" style={{maxWidth:'800px'}}>IrrigationBossPro is field service software built specifically for lawn care and pest control businesses that apply spray treatments. Every feature is designed around how a mosquito spray company actually operates — recurring program management, sq ft or linear ft-based route planning, chemical application logs, and automated customer communication.</p>
        </div>
        <div className="feature-grid">
          ...
          <div className="feature-card">
            ...
            <p>Before you build a route, see exactly how many sq ft or linear ft of mosquito service are waiting to be scheduled. IrrigationBossPro organizes your waiting list by service type — Mosquito 3, Mosquito 4, any program name you use — so you know exactly what&apos;s pending.</p>
          </div>
          <div className="feature-card">
            <div className="feature-icon">🔄</div>
            <h3>Recurring Mosquito Program Management</h3>
            <p>Mosquito spray businesses run recurring treatment programs — monthly, every 21 days, seasonal. When a mosquito treatment is marked complete, IrrigationBossPro automatically puts the next scheduled treatment back on the waiting list. Programs manage themselves.</p>
          </div>
          <div className="feature-card">
            <div className="feature-icon">💬</div>
          ...
          <div className="feature-card">
            ...
            <p>Sell seasonal mosquito packages — 6-treatment programs, monthly plans, or custom service packages. IrrigationBossPro tracks treatments remaining, notifies you when packages expire, and makes renewing a customer&apos;s mosquito program a two-click process.</p>
          </div>
        </div>
      </section>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="highlight-row">
          <div className="highlight-text">
            ...
            <p>Open your map, draw a circle around any area — a neighborhood, a subdivision, a zip code — and IrrigationBossPro instantly shows you every property with a mosquito treatment due inside that boundary: how many stops, how many sq ft or linear ft, and how much revenue.</p>
      ...
      <section>
        <div className="highlight-row reverse">
          <div className="highlight-text">
            ...
            <p>Before you open the map and start building a mosquito spray route, IrrigationBossPro shows you a waiting list organized by service type and total square footage. You can see at a glance how much Mosquito 3 is due, how much Mosquito 4 is waiting, and how many properties of each type are in the queue.</p>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto 64px'}}>
          ...
          <p className="section-sub">IrrigationBossPro is designed so that building and completing a full day of mosquito spray routes takes minutes, not hours. For a closer look at how one platform handles the waiting list, circle routing, mobile dispatch, compliance logs, and automated SMS end to end, read <a href="/blogs/run-mosquito-spray-business-single-platform" style={{color:'var(--orange)', fontWeight:600}}>How to Run a Mosquito Spray Business From a Single Platform</a>.</p>
        </div>
        <div className="steps-grid">
          <div className="step-box"><div className="step-circle">1</div><h3>Check the Waiting List</h3><p>Open IrrigationBossPro and see exactly how many sq ft or linear ft of mosquito treatment is waiting — organized by service type. Know your day before you build anything.</p></div>
          ...
          <div className="step-box"><div className="step-circle">4</div><h3>Treatment Complete — Next One Scheduled</h3><p>When the technician marks a mosquito treatment complete, IrrigationBossPro automatically schedules the next treatment and puts it back on the waiting list.</p></div>
        </div>
      </section>
      ...
      <div className="premium-band">
        ...
        <p>IrrigationBossPro isn&apos;t a general field service platform that happens to work for mosquito spray. It&apos;s built specifically for businesses that apply chemical treatments — with the route planning, compliance logging, and program management that mosquito spray companies actually use.</p>
        <div className="premium-grid">
          ...
          <div className="premium-card"><div className="premium-card-icon">📦</div><h4>Mosquito Package Programs</h4><p>Sell seasonal mosquito programs and track treatments remaining. IrrigationBossPro notifies you before packages expire and makes renewals fast.</p></div>
          ...
          <div className="premium-card"><div className="premium-card-icon">👥</div><h4>Unlimited Technicians</h4><p>Add as many technicians as you run mosquito routes. IrrigationBossPro doesn&apos;t cap users. Run 1 truck or 10 — the price stays the same.</p></div>
        </div>
      </div>
      ...
      <section style={{background:'#fff'}}>
        <div style={{maxWidth:'860px', margin:'0 auto', padding:'80px 40px'}}>
          ...
          {[
            {q:'Does IrrigationBossPro work specifically for mosquito spray businesses?', a:'Yes. IrrigationBossPro is purpose-built for spray businesses including mosquito barrier spray. It has 21-day auto-interval scheduling, sq ft and linear ft measurement fields per property, a waiting list sorted by treatment due date, circle-map route building, and chemical application logs with EPA registration numbers — built around the mosquito spray model, not adapted from a generic tool.'},
            {q:'How does IrrigationBossPro handle the 21-day treatment interval?', a:'When a technician logs a completion, IrrigationBossPro automatically calculates the next due date (21 days from completion) and places the account back on the waiting list. No manual rebooking required. The account appears ready to schedule when it\'s due, with all property details and pricing pre-populated.'},
            {q:'Can I track chemical application compliance for mosquito spray?', a:'Yes. IrrigationBossPro logs the product, application rate, EPA registration number, area treated, weather conditions, and applicator license for every treatment. The chemical tracking report generates a print-ready compliance document on demand — no separate paper logs needed.'},
            {q:'Does IrrigationBossPro send automated SMS to mosquito spray customers?', a:'Yes. Pre-built SMS alert types include day-before appointment reminders, on-the-way notifications, and post-service completion messages with re-entry interval instructions. Alerts fire automatically when the technician dispatches or logs completion. 500 outbound SMS messages per month are included at no extra charge.'},
            {q:'Can I manage multiple trucks from one account?', a:'Yes. IrrigationBossPro supports unlimited technicians and multiple trucks — the price stays at $129/month regardless of crew size. The waiting list and dispatch board show all accounts across all trucks and can be assigned to specific technicians per route day.'},
            {q:'How much does IrrigationBossPro cost for a mosquito spray business?', a:'$129/month, flat. No per-user fees, no SMS add-ons, no extra charge for chemical logs or route building. Every feature is included. There\'s a 14-day free trial with no credit card required.'},
          ].map(({q, a}, i, arr) => (
          ...
          <p style={{marginTop:'40px', color:'var(--muted)', fontSize:'15px', lineHeight:1.7}}>IrrigationBossPro is purpose-built mosquito spray software — <a href="/" style={{color:'var(--orange)', fontWeight:600}}>see the full platform overview</a> to learn everything that's included.</p>
        </div>
      </section>
      ...
      <div className="cta-band">
        ...
        <p>IrrigationBossPro is $129/month — schedule mosquito treatments, build routes with Lasso, log every application, and send automated SMS alerts from day one. No add-ons required.</p>
        <div className="hero-btns">

    ...
    <>
      ...
      <div style={{background:'var(--purple-dark)', padding:'0 40px 60px', textAlign:'center'}}>
        <img
          ...
          fetchPriority="high"
          decoding="async"
          alt="IrrigationBossPro spray business software dashboard showing circle-map routing, waiting list, and mobile dispatch on laptop and phone"
      ...
      <section>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto'}}>
          ...
          <h2 className="section-title">If Your Business Sprays, IrrigationBossPro Was Built for You.</h2>
          <p className="section-sub" style={{maxWidth:'800px'}}>General field service software is built for plumbers, cleaners, and HVAC companies. IrrigationBossPro is built for businesses that apply chemical treatments — with sq ft or linear ft routing, compliance logging, and program management that spray companies actually need.</p>
        </div>
        <div className="audience-grid">
          ...
          <div className="audience-card">
            ...
            <p>Run multiple spray service lines from one platform. IrrigationBossPro organizes your waiting list by service type — so your lawn crew and mosquito crew each see exactly what they need.</p>
          </div>
        </div>
      </section>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="highlight-row">
          <div className="highlight-text">
            ...
            <p>Every morning before you build routes, IrrigationBossPro shows you a waiting list organized by service type — with total sq ft or linear ft and total stops waiting for each. Your lawn crew sees their list. Your mosquito crew sees theirs.</p>
      ...
      <section>
        <div className="highlight-row reverse">
          <div className="highlight-text">
            ...
            <p>Stop building spray routes one address at a time. Open your map, draw a circle around any neighborhood or service area, and IrrigationBossPro instantly shows you every property with a spray treatment due inside that boundary — service type, sq ft or linear ft, and route revenue.</p>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="highlight-row">
          <div className="highlight-text">
            ...
            <p>Every state requires pesticide applicators to keep records of every chemical application — product name, EPA registration number, application rate, total area or linear ft treated, weather conditions, and applicator license number. IrrigationBossPro logs all of it on every job.</p>
      ...
      <section>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto 64px'}}>
          ...
          <p className="section-sub">IrrigationBossPro is designed so that building and dispatching a full day of spray routes takes minutes, not an hour. For a closer look at how the waiting list and circle routing eliminate the morning dispatch bottleneck, read <a href="/blogs/run-spray-business-without-office-manager" style={{color:'var(--orange)', fontWeight:600}}>How to Run a Spray Business Without an Office Manager</a>.</p>
        </div>
        <div className="steps-grid">
          <div className="step-box"><div className="step-circle">1</div><h3>Check the Waiting List</h3><p>Open IrrigationBossPro and see every service due today — organized by service type with total sq ft or linear ft waiting. Know your day before you build anything.</p></div>
      ...
      <div className="premium-band">
        ...
        <p>IrrigationBossPro isn&apos;t a generic field service app with a spray-business skin. It&apos;s built from the ground up for businesses that apply chemical treatments — with the routing, compliance logging, and program management that spray companies actually use every day.</p>
        <div className="premium-grid">
          ...
          <div className="premium-card"><div className="premium-card-icon">📦</div><h4>Package Plans &amp; Programs</h4><p>Sell seasonal spray packages and multi-treatment programs. IrrigationBossPro tracks treatments remaining and notifies you before programs expire.</p></div>
          ...
          <div className="premium-card"><div className="premium-card-icon">👥</div><h4>Unlimited Technicians</h4><p>Run 1 spray truck or 10. IrrigationBossPro doesn&apos;t charge per user. Add every technician in your company — the price stays $129/month.</p></div>
        </div>
      </div>
      ...
      <section style={{background:'#fff'}}>
        <div style={{maxWidth:'860px', margin:'0 auto', padding:'80px 40px'}}>
          ...
          {[
            {q:'What types of spray businesses does IrrigationBossPro work for?', a:'IrrigationBossPro is built for any business that applies chemical treatments on recurring routes — mosquito spray, lawn care, weed control, fertilizer, and pest control. It handles multi-service scheduling, compliance logging, route building by sq ft, and automated SMS across all service types from one platform.'},
            {q:'Does IrrigationBossPro handle chemical compliance for spray businesses?', a:'Yes. Every treatment logs the product, EPA registration number, application rate, target pest or weed, treatment area, weather, and applicator license. The chemical tracking report generates a print-ready compliance log for state inspection — no paper records needed.'},
            {q:'Can I manage multiple service types in one account?', a:'Yes. IrrigationBossPro manages mosquito spray, lawn care, weed control, fertilizer, and pest control from one account. The waiting list filters by service type, each service has its own SMS alert configuration, and circle-map routing shows only the service type you\'re scheduling.'},
            {q:'Does IrrigationBossPro send automated customer communication?', a:'Yes. Pre-built SMS alert templates cover every touchpoint: day-before appointment reminders, on-the-way notifications, completion messages, and re-entry interval notices. Alerts fire automatically from dispatch and completion events — configured once, sent on every job.'},
            {q:'Can I run multiple technicians and trucks?', a:'Yes. IrrigationBossPro supports unlimited technicians at $129/month — no per-user fees regardless of crew size. The dispatch board assigns routes to specific technicians, and each uses the mobile app for their stops, property details, and chemical log.'},
            {q:'How much does IrrigationBossPro cost?', a:'$129/month, flat. Every feature — route scheduling, chemical compliance logs, SMS alerts, card-on-file payments, estimates — is included. No per-user fees, no add-ons. 14-day free trial, no credit card required.'},
          ].map(({q, a}, i, arr) => (
          ...
          <p style={{marginTop:'40px', color:'var(--muted)', fontSize:'15px', lineHeight:1.7}}>IrrigationBossPro is the all-in-one platform for spray businesses — <a href="/" style={{color:'var(--orange)', fontWeight:600}}>see the full platform overview</a> to learn everything that's included.</p>
        </div>
      </section>

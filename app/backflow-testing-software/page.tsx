...
async function sbpCreateAccount(n: number) {
  ...
  try {
    ...
    const iv = setInterval(() => {
      secs--;
      if (secs <= 0) { clearInterval(iv); window.location.href = 'https://my.irrigationbosspro.com/dashboard.html'; }
...
export default function BackflowTestingSoftware() {
  useEffect(() => {
  ...
  return (
    <>
      ...
      <div className="hero">
        ...
        <h1>Backflow Testing Software<br /><span>Built for How Sprinkler Pros Actually Work</span></h1>
      ...
      <div style={{background:'var(--purple-dark)', padding:'0 40px 60px', textAlign:'center'}}>
        <img
          ...
          fetchPriority="high"
          decoding="async"
          alt="IrrigationBossPro backflow testing software dashboard on laptop showing certification renewal list and dispatch board, with mobile app on phone"
      ...
      <div className="premium-band">
        ...
        <div className="premium-grid">
          ...
          <div className="premium-card"><div className="premium-card-icon">💳</div><h4>Stripe Payments</h4><p>Cards on file, invoicing, charge after the test, payment tracking, overdue reports — the full Stripe integration is wired in. Collect for a backflow test on the spot and see every dollar in one place.</p></div>
          <div className="premium-card"><div className="premium-card-icon">🔐</div><h4>Role-Based Access</h4><p>Owner, Manager, Office Staff, Technician, and Mobile-only roles. Granular permission control so your field techs only see the jobs they need and your office manager can&apos;t accidentally delete a property record.</p></div>
          <div className="premium-card"><div className="premium-card-icon">📱</div><h4>Mobile App for Your Crew</h4><p>Your technicians get a mobile-optimized dashboard with their stops for the day. Complete a test, log device readings, add parts used, and mark notes — all from the truck without calling the office once.</p></div>
        </div>
      </div>
      ...
      <section className="dark-section">
        <div className="highlight-row">
          <div className="highlight-text">
            ...
            <h2 style={{color:'#fff'}}>Draw a Circle on the Map. See Every Backflow Test Due Inside It.</h2>
            <p style={{color:'rgba(255,255,255,.65)'}}>Lasso is the fastest way to build an irrigation route we&apos;ve ever seen. Draw a circle on your service area map and IrrigationBossPro instantly surfaces every property inside that radius with a backflow test due, a winterization scheduled, or a repair waiting — with stop count, job type, and estimated revenue all calculated in real time before you commit to a single schedule.</p>
            <ul className="check-list" style={{marginTop:'20px'}}>
              <li style={{color:'rgba(255,255,255,.75)'}}>Draw any size circle on the map — instantly see all properties inside</li>
              <li style={{color:'rgba(255,255,255,.75)'}}>Breaks out stops by job type: tests, repairs, installs, winterizations</li>
              ...
              <li style={{color:'rgba(255,255,255,.75)'}}>Works across every job type simultaneously in one view</li>
              <li style={{color:'rgba(255,255,255,.75)'}}>Cuts route-building time from an hour to under 5 minutes</li>
              <li style={{color:'rgba(255,255,255,.75)'}}>No competitor has this. It doesn&apos;t exist anywhere else in irrigation software.</li>
            </ul>
          </div>
          <div className="highlight-visual">
            ...
            <div style={{display:'grid', gridTemplateColumns:'1fr 1fr', gap:'8px'}}>
              ...
              <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px'}}>
                <div style={{color:'#84cc16', fontSize:'18px', fontWeight:800}}>11</div>
                <div style={{color:'rgba(255,255,255,.42)', fontSize:'11px', marginTop:'1px'}}>Backflow Tests Due</div>
              </div>
              <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px'}}>
                <div style={{color:'#84cc16', fontSize:'18px', fontWeight:800}}>$3,840</div>
                <div style={{color:'rgba(255,255,255,.42)', fontSize:'11px', marginTop:'1px'}}>Est. Revenue</div>
              </div>
              <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', gridColumn:'span 2'}}>
                <div style={{color:'#fff', fontSize:'13px', fontWeight:600}}>Backflow Tests · 11 &nbsp;|&nbsp; Repairs · 5 &nbsp;|&nbsp; Installs · 3</div>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto 56px'}}>
          ...
          <p className="section-sub" style={{maxWidth:'720px'}}>Most powerful software is complicated. IrrigationBossPro is the exception. Every screen was designed by people who ran sprinkler routes and pulled backflow tests — not UX designers who&apos;ve never opened a valve box. Your team will be using it confidently on day one.</p>
        </div>
        <div style={{display:'grid', gridTemplateColumns:'repeat(auto-fit, minmax(240px, 1fr))', gap:'24px', maxWidth:'1100px', margin:'0 auto'}}>
          {[
            {n:'01', title:'Set Up in One Afternoon', body:'Add your services, import your clients and properties, log your backflow devices, set up automated alerts, and connect Stripe — most owners are fully operational the same day they sign up. No implementation consultant, no onboarding call, no 90-day setup timeline.'},
            {n:'02', title:'One Screen Does Everything', body:'Scheduling, dispatch, the job board, the map, and your device records are all connected. You\'re not jumping between five different modules or browser tabs. Pull up the dispatch board and every test, repair, and install for the day is right there in a single view.'},
            {n:'03', title:'Your Techs Learn It in Minutes', body:'The mobile app your technicians use shows them exactly what they need and nothing they don\'t. Their stops for the day, the property and device info, the job notes, the parts list, and the complete button. No training videos, no IT ticket, no frustrated crew members.'},
            {n:'04', title:'Automation Runs Without You', body:'Set up your SMS alerts, certification-renewal reminders, estimate follow-ups, and payment reminders once. After that, IrrigationBossPro handles every notification and every follow-up automatically — whether you\'re on a route, at home, or on vacation.'},
          ].map(({n, title, body}) => (
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto'}}>
          ...
          <p className="section-sub">Irrigation is not plumbing. You&apos;re juggling backflow tests with hard renewal deadlines, parts-heavy repair jobs, multi-day system installs, and a wave of winterizations and spring start-ups that all hit in the same few weeks. A generic ticket-per-job tool falls apart fast.</p>
        </div>
        <div style={{maxWidth:'900px', margin:'0 auto'}}>
          <div style={{background:'#fff', border:'1.5px solid var(--border)', borderRadius:'14px', padding:'36px 40px', borderLeft:'5px solid var(--orange)'}}>
            <p style={{fontSize:'17px', color:'var(--text)', lineHeight:1.8, marginBottom:'16px'}}>When we were running our own sprinkler routes, we tried every piece of software out there. The big names, the small names, the ones built for &quot;field service.&quot; None of them understood what it meant to track <strong>hundreds of backflow assemblies</strong> with their own annual renewal dates, and need to know exactly which devices are coming due this month before you build a single route.</p>
            ...
            <p style={{fontSize:'17px', color:'var(--text)', lineHeight:1.8}}>Every feature in IrrigationBossPro exists because we needed it on a real backflow test, a valve repair, or a fall blowout. Not because a product manager in a tech office decided it sounded good.</p>
          </div>
        </div>
      </section>
      ...
      <section>
        <div className="centered" style={{maxWidth:'1200px', margin:'0 auto'}}>
          ...
          <p className="section-sub">Every tool in IrrigationBossPro was built with irrigation and backflow workflows in mind — not adapted from a plumbing app and called good enough.</p>
        </div>
        <div className="feature-grid">
          {[
            {icon:'🛡️', title:'Backflow Device Records', body:'Every assembly gets its own record: make, model, serial number, size, location on the property, last test date, and next renewal date. IrrigationBossPro becomes the single source of truth for every device you service.'},
            {icon:'🔔', title:'Certification Renewal Tracking', body:'The system flags every backflow test coming due so the deadline never slips. Run a list of all devices due this month and turn it straight into a route — no spreadsheet, no missed renewals.'},
            ...
            {icon:'🧾', title:'Line-Item Estimates', body:'Build a detailed irrigation estimate in minutes — assemblies, rebuild kits, valves, heads, controllers, pipe, and labor all itemized from your catalog. Email it from the platform and let clients accept with one click.'},
            {icon:'📦', title:'Materials &amp; Parts Tracking', body:'Pull from a saved catalog of heads, valves, controllers, pipe, fittings, and backflow devices when you build a bid or close out a job. Know the exact parts used on every repair and install.'},
            {icon:'🔁', title:'Recurring Seasonal Service', body:'Set up winterization, spring start-up, and annual backflow testing as recurring services. IrrigationBossPro queues them onto your job board each season so the same customers come back automatically.'},
            {icon:'💬', title:'Automated Service Alerts', body:'Automatically text customers when a job is scheduled, when your tech is on the way, and when the work is done. Set it once — IrrigationBossPro handles the communication for every single stop.'},
            {icon:'💳', title:'Card-on-File Payments', body:'Store cards on file via Stripe. Charge after a backflow test, send invoices, and collect without chasing anyone down. Every dollar tracked in one place.'},
            {icon:'📱', title:'Mobile App for Technicians', body:'Your techs get a mobile-optimized view of their stops for the day. Mark jobs complete, log device readings, record parts used, skip, or reschedule — right from the truck.'},
            {icon:'🏠', title:'Property &amp; Client Profiles', body:'Every property has its own record — zones, controller location, backflow devices, service history, notes, GPS coordinates, and photos. Everything tied to the address, not just the customer.'},
            {icon:'📋', title:'The Job Board', body:'Tests, repairs, installs, winterizations, and start-ups all sit on one board, filtered by type and status. See exactly what&apos;s waiting, what&apos;s scheduled, and what&apos;s done at a glance.'},
            ...
            {icon:'⭐', title:'Automated Review Requests', body:'After every completed test or install, IrrigationBossPro automatically sends a Google review request to the customer — on your schedule, every time, without you lifting a finger.'},
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="highlight-row">
          <div className="highlight-text">
            <span className="section-label">Backflow Testing Scheduling</span>
            <h2>Know Exactly Which Devices Are Due Before You Build a Single Route</h2>
            <p>This is the feature no other irrigation software has. IrrigationBossPro&apos;s renewal list doesn&apos;t just show you what properties need service — it shows you every backflow assembly grouped by renewal month so you know exactly how many tests are due before you start making calls. For a closer look at how device tracking and the job board run the day-to-day of a backflow operation, read <a href="/blogs/backflow-testing-software-complete-guide" style={{color:'var(--orange)', fontWeight:600}}>Backflow Testing Software: The Complete Guide for Irrigation Contractors</a>.</p>
            <ul className="check-list">
              <li>Renewal list grouped by month with device counts</li>
              <li>Schedule directly from the renewal list in one click</li>
              ...
              <li>Mark tests passed, failed, or rescheduled from the field</li>
              <li>Print dispatch sheets for drivers</li>
              <li>Summary bar: total stops, tests, revenue for the day</li>
            </ul>
          </div>
          <div className="highlight-visual">
            <div style={{color:'rgba(255,255,255,.5)', fontSize:'11px', textTransform:'uppercase', letterSpacing:'1px', marginBottom:'14px'}}>Renewal List — By Month Due</div>
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#f97316', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>June — Due Now</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>47 devices to test</div></div>
              <div style={{marginLeft:'auto', background:'#ea580c', color:'#fff', fontSize:'11px', fontWeight:700, padding:'3px 9px', borderRadius:'10px'}}>47 tests</div>
            </div>
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#84cc16', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>July — Coming Due</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>31 devices to test</div></div>
              <div style={{marginLeft:'auto', background:'#84cc16', color:'#fff', fontSize:'11px', fontWeight:700, padding:'3px 9px', borderRadius:'10px'}}>31 tests</div>
            </div>
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#bef264', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>August — Upcoming</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>22 devices to test</div></div>
              <div style={{marginLeft:'auto', background:'#2272c3', color:'#fff', fontSize:'11px', fontWeight:700, padding:'3px 9px', borderRadius:'10px'}}>22 tests</div>
            </div>
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#22c55e', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>September — Upcoming</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>15 devices to test</div></div>
              <div style={{marginLeft:'auto', background:'#16a34a', color:'#fff', fontSize:'11px', fontWeight:700, padding:'3px 9px', borderRadius:'10px'}}>15 tests</div>
            </div>
      ...
      <section>
        <div className="highlight-row reverse">
          <div className="highlight-text">
            <span className="section-label">Test Records</span>
            <h2>Device Records Built for Backflow Compliance</h2>
            <p>Every water purveyor requires backflow test records on file. IrrigationBossPro makes it automatic — every test is logged the moment the job is marked complete, with the gauge readings and pass/fail result, and you can pull a full history for any device or any authority in seconds.</p>
            <ul className="check-list">
              <li>Log device make, model, size, and serial number per assembly</li>
              <li>Record gauge readings and pass/fail result per test</li>
              <li>Track certified tester and gauge calibration on file</li>
              <li>Store the location of every device on the property</li>
              <li>Filter records by client, tester, device, or date range</li>
              <li>Print-ready test reports for any water authority</li>
              <li>Full history of every test on every device kept in the system</li>
            </ul>
          </div>
          <div className="highlight-visual">
            <div style={{color:'rgba(255,255,255,.5)', fontSize:'11px', textTransform:'uppercase', letterSpacing:'1px', marginBottom:'14px'}}>Test Log — June 2026</div>
            <div style={{display:'grid', gridTemplateColumns:'1fr 1fr', gap:'8px', marginBottom:'12px'}}>
              <div style={{background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'12px', textAlign:'center'}}>
                ...
                <div style={{color:'rgba(255,255,255,.45)', fontSize:'11px'}}>Tests Completed</div>
              </div>
              <div style={{background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'12px', textAlign:'center'}}>
              ...
              <div style={{background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'12px', textAlign:'center'}}>
                <div style={{color:'#84cc16', fontSize:'20px', fontWeight:700}}>201</div>
                <div style={{color:'rgba(255,255,255,.45)', fontSize:'11px'}}>Passed</div>
              </div>
              <div style={{background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'12px', textAlign:'center'}}>
                <div style={{color:'#f97316', fontSize:'20px', fontWeight:700}}>17</div>
                <div style={{color:'rgba(255,255,255,.45)', fontSize:'11px'}}>Failed — Rebuild Quoted</div>
              </div>
            </div>
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#22c55e', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Wilkins 975XL · 1&quot; RP</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>J. Smith · Renewal +1 yr</div></div>
              <div style={{background:'#16a34a', color:'#fff', fontSize:'11px', fontWeight:700, padding:'3px 9px', borderRadius:'10px'}}>Passed</div>
            </div>
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#f97316', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Febco 765 · 3/4&quot; PVB</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>M. Torres · Rebuild kit needed</div></div>
              <div style={{background:'#ea580c', color:'#fff', fontSize:'11px', fontWeight:700, padding:'3px 9px', borderRadius:'10px'}}>Failed</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section style={{background:'var(--light-bg)'}}>
        ...
        <div style={{maxWidth:'520px', margin:'0 auto'}}>
          <div className="lc-price-card featured">
            ...
            <div style={{color:'var(--muted)', fontSize:'14px', marginBottom:'24px', lineHeight:1.5}}>Every feature. Unlimited clients, properties, devices, employees, and users. No tiers, no locked features, no per-seat fees.</div>
            <ul className="price-features">
              <li>Unlimited Clients, Properties &amp; Devices</li>
              <li>Unlimited Employees &amp; Users</li>
              <li>Full Scheduling, Dispatch &amp; Route Map</li>
              <li>Backflow Device &amp; Renewal Tracking</li>
              <li>Line-Item Estimates, Invoices &amp; Stripe Payments</li>
              <li>Two-Way SMS &amp; Automated Alerts</li>
              <li>Materials &amp; Parts Catalog</li>
              <li>Recurring Seasonal Service &amp; Renewals</li>
      ...
      <section style={{background:'#fff'}}>
        <div style={{maxWidth:'860px', margin:'0 auto', padding:'80px 40px'}}>
          ...
          <h2 className="section-title" style={{marginBottom:'48px'}}>Backflow Testing Software — Common Questions</h2>
          {[
            {q:'Is IrrigationBossPro built for backflow testing businesses?', a:'Yes. IrrigationBossPro handles the full backflow operation: device records with annual renewal tracking, test scheduling and dispatch, pass/fail logging, rebuild estimates, automated customer SMS, and card-on-file payments. It\'s designed for irrigation contractors who test and certify assemblies, not general service businesses.'},
            {q:'Can I manage backflow testing alongside repairs, installs, and winterizations in one platform?', a:'Yes. IrrigationBossPro runs every job type from one account on a single job board. Backflow tests, valve and head repairs, new system installs, fall winterizations, and spring start-ups all live side by side with job-specific SMS alerts and independent pricing.'},
          ...
          <p style={{marginTop:'40px', color:'var(--muted)', fontSize:'15px', lineHeight:1.7}}>IrrigationBossPro handles backflow testing alongside system installs, valve and head repairs, winterizations, and spring start-ups — all from one platform — <a href="/" style={{color:'var(--orange)', fontWeight:600}}>see the full IrrigationBossPro overview</a>.</p>
        </div>
      </section>

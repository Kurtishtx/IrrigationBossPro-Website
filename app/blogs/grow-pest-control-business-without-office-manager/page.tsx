...
export const metadata = {
  title: 'Grow Pest Control Without Hiring an Office Manager | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro automates the scheduling, communication, and billing functions that would otherwise require a dedicated office manager — so pest control companies can grow their account base without growing their office payroll in parallel.</p>

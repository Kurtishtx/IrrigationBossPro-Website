...
export const metadata = {
  title: 'Fertilizer Program Pricing by Square Foot | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Pricing &amp; Revenue</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro calculates expected revenue per stop from stored sq ft data and assigned rates — visible on every route summary so you know the financial profile of every day&apos;s fertilizer schedule.</p>

...
export const metadata = {
  title: 'Mosquito Spray vs Other Pest Control Businesses | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro is purpose-built for mosquito spray businesses — with the interval scheduling, measurement fields, seasonal structure, and compliance communication that distinguish barrier spray from general pest control.</p>

...
export const metadata = {
  title: 'Chemical Compliance Tracking for Spray Businesses | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro captures all required compliance fields via required form fields and product library pre-fill — submitted in the field, immediately searchable in the office, exportable for any inspection request.</p>

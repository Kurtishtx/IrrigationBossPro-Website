...
export const metadata = {
  title: 'Build a Fertilizer Route With Map-Based Routing | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Routing &amp; Efficiency</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro&apos;s Lasso map routing lets you draw a circle around any neighborhood, pull every fertilizer stop due inside, optimize drive order, and dispatch to technician phones — all in one session.</p>

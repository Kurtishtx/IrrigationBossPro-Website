...
export const metadata = {
  title: 'What Pest Control Customers Expect From Programs | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro handles timely scheduling, pre-visit SMS, post-service confirmation, property notes for every technician, and callback routing — the five things recurring pest control customers expect, delivered automatically.</p>

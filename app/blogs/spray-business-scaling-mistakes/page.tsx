...
export const metadata = {
  title: 'Biggest Spray Business Scaling Mistakes | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro gives spray businesses the operational infrastructure to scale past 5, 10, and 15 trucks without the manual system failures that create compliance risk, customer churn, and dispatch bottlenecks.</p>

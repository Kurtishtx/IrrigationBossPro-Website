...
export const metadata = {
  title: 'Price Mosquito Barrier Spray Programs for Profit | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro stores sq ft and linear ft per property, calculates per-treatment revenue, and shows route revenue totals before dispatch — so you know what every route day generates before the technician leaves.</p>

...
export const metadata = {
  title: 'Auto-Schedule Recurring Lawn Treatments | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro auto-reschedules every customer after each completed visit so your waiting list is always accurate and your office isn&apos;t manually rebooking 1,400 treatments per season.</p>

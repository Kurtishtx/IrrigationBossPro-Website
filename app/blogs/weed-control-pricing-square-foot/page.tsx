...
export const metadata = {
  title: 'Weed Control Pricing by Square Foot | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro calculates expected revenue per stop from stored sq ft and assigned rates — visible on every route summary, waiting list view, and customer account history.</p>

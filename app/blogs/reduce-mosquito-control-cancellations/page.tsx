...
export const metadata = {
  title: 'Reduce Mosquito Control Cancellations With SMS | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Retention</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro fires pre-service reminders, post-service confirmations with REI, and next-visit estimates automatically on every mosquito visit — reducing no-access stops and mid-season cancellations without your team sending a single message.</p>

...
export const metadata = {
  title: 'Pest Control Software for Recurring Treatments | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro is purpose-built for pest control companies running recurring programs — with every feature the industry requires at $129/month flat, no add-ons.</p>

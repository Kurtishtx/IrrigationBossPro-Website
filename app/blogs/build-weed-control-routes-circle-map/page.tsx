...
export const metadata = {
  title: 'Build Weed Control Routes With Circle Map Routing | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro&apos;s circle map routing shows every weed control stop due in any area you select — with total sq ft, stop count, service type breakdown, and drive-optimized route order — before you dispatch a single stop.</p>

...
export const metadata = {
  title: 'Automatic Re-Entry Interval Texts: Weed Control | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro pulls the REI from the completed field log and sends the post-service SMS automatically — correct interval, correct product, correct customer, zero office action required.</p>

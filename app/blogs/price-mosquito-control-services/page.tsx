...
export const metadata = {
  title: 'How to Price Mosquito Control Services | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro stores property measurements on every mosquito account and calculates expected route revenue automatically — so dispatchers see the day&apos;s revenue before building the first route.</p>

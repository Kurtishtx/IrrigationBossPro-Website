...
export const metadata = {
  title: 'Pest Control Software: Estimate to First Service | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro converts pest control estimate acceptances to active customer accounts instantly — with automatic setup, waiting list entry, and customer confirmation in a single system action.</p>

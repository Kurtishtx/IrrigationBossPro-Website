...
export const metadata = {
  title: 'Manage Spray Technicians in the Field | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Field Management</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro gives spray technicians everything they need on their mobile device and gives the office real-time route visibility — so field management happens through the software, not through constant phone calls.</p>

...
export const metadata = {
  title: 'Grow a Spray Business From Zero to 500 Customers | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro gives spray businesses the waiting list, circle routing, compliance logging, and automated SMS that scale smoothly from 50 customers to 500 without adding administrative staff proportionally.</p>

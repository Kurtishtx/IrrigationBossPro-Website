...
export const metadata = {
  title: 'What Customers Expect After Weed Control | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Customer Experience</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro fires scheduled confirmation, service complete with product-specific REI, and next-visit estimate texts automatically for every weed control stop — so your customers always know what happened and what&apos;s next without your team doing anything.</p>

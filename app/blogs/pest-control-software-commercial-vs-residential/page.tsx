...
export const metadata = {
  title: 'Pest Control Software: Commercial vs Residential | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro manages commercial and residential pest control accounts from the same waiting list, routing, compliance, and billing platform — with flexible billing models, property-level access notes, and filterable compliance records.</p>

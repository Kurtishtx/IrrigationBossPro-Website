...
export const metadata = {
  title: 'Automated Customer Alerts for Every Spray Service | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro fires all three customer alerts automatically — triggered by dispatch, by technician transit, and by compliance log submission — with service-type-specific language and product-accurate re-entry intervals.</p>

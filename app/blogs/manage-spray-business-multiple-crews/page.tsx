...
export const metadata = {
  title: 'Manage a Spray Business Across Multiple Crews | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Multi-Crew Operations</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro handles multi-crew spray dispatch, real-time progress tracking for all trucks, and compliance log visibility across all field technicians — from the same platform the dispatcher uses for single-crew routes.</p>

...
export const metadata = {
  title: 'Pest Control Chemical Logs for State Inspectors | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro&apos;s chemical tracking report produces complete, print-ready compliance records for any date range, product, property, or technician — so state inspections are a non-event, not a crisis.</p>

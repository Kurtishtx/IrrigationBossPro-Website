...
export const metadata = {
  title: 'Manage Multiple Services in a Spray Business | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro manages every spray service type with independent scheduling intervals, service-specific compliance logs, and per-type SMS templates — all from the same platform your dispatcher uses every morning.</p>

...
export const metadata = {
  title: 'Lawn Care Software and Chemical Compliance | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro makes compliance automatic — every chemical application is logged via the field form as the completion action, with EPA reg numbers pre-filled and records available for any inspection in under 5 minutes.</p>

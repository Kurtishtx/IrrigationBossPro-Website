...
export const metadata = {
  title: 'Re-Entry Interval After Weed Control Applications | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Compliance &amp; Communication</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro pulls the REI from the completed compliance log and fires the post-service SMS with the correct interval — no static templates, no manually entered times, no liability exposure from wrong information.</p>

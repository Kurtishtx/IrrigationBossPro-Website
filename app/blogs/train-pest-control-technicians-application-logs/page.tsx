...
export const metadata = {
  title: 'Train Pest Control Technicians to Log Applications | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro&apos;s compliance log form can&apos;t be submitted with missing required fields, pre-fills hard data from the product library, and uses mobile-native checklists that submit in under 90 seconds per stop.</p>

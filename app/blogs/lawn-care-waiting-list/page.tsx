...
export const metadata = {
  title: 'What Is a Lawn Care Waiting List? | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro&apos;s waiting list shows every pending customer organized by service type with square footage totals — so your mornings start with clarity, not guesswork.</p>

...
export const metadata = {
  title: 'Nutsedge and Specialty Weed Control Programs | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Specialty Programs</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro lets you configure nutsedge control as a separate service type with its own interval, products, compliance log template, and SMS — so specialty programs don&apos;t disrupt your standard program scheduling.</p>

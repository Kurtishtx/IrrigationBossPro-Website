...
export const metadata = {
  title: 'Mosquito Spray: Linear Foot Measurement Tracking | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro treats mosquito spray linear ft as a native measurement field — stored per property, totaled on the waiting list, used in per-treatment pricing calculations, and recorded in the chemical compliance log.</p>

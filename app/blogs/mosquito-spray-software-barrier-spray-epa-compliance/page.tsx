...
export const metadata = {
  title: 'Mosquito Spray Software: EPA Compliance Tracking | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro captures full EPA compliance data at every mosquito treatment completion and generates a printable chemical tracking report for state inspection — no separate log required.</p>

...
export const metadata = {
  title: 'Manage Multiple Pest Control Program Intervals | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Pest Control Scheduling</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro manages every recurrence interval independently, auto-schedules the next visit on completion, and surfaces each program type in a filterable waiting list with sq ft totals and revenue visibility.</p>

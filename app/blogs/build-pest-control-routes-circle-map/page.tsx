...
export const metadata = {
  title: 'Build Pest Control Routes With Circle Map Routing | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Routing</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro&apos;s circle map routing shows every pest control stop due in any area you select — with total stops, expected revenue, program type breakdown, and optimized drive order — before you dispatch a single truck.</p>

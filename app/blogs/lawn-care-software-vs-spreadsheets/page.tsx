...
export const metadata = {
  title: 'Lawn Care Software vs. Spreadsheets | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro replaces the manual work behind your spreadsheet with automated scheduling, dispatch, alerts, and billing — built specifically for lawn care programs.</p>

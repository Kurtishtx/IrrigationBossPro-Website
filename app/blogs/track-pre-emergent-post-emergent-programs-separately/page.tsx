...
export const metadata = {
  title: 'Track Pre- and Post-Emergent Programs Separately | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Program Management</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro lets you configure pre-emergent and post-emergent as distinct service types with separate waiting lists, compliance log templates, and SMS alerts — no combined tracking, no mixed-up round numbers.</p>

...
export const metadata = {
  title: 'Log Target Pests and EPA Reg Numbers Per Stop | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Field Logging</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro&apos;s product library pre-fills EPA reg numbers when a product is selected, and treatment area checklists let technicians log specific areas in two taps — complete, state-ready records on every stop.</p>

...
export const metadata = {
  title: 'Lawn Care Software Customer Notifications | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro&apos;s automated SMS alert system fires at every customer touchpoint in the service lifecycle — customizable templates, accurate REI from the product record, and two-way texting for customer responses.</p>

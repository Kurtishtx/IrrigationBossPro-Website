...
export const metadata = {
  title: 'Lawn Care Software for Multiple Service Types | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro handles multiple simultaneous service programs per property under a single account — each with separate sq ft areas, separate waiting list entries, separate product mixes, and separate auto-scheduling intervals.</p>

...
export const metadata = {
  title: 'Scale a Weed Control Program Without Adding Staff | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Growth &amp; Scaling</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro auto-schedules rounds, auto-populates the waiting list, auto-sends customer SMS, and captures field-submitted compliance logs — so adding customers doesn&apos;t add scheduling, logging, or communication overhead to your office.</p>

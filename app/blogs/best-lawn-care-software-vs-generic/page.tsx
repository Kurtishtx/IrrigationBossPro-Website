...
export const metadata = {
  title: 'What the Best Lawn Care Software Does Differently | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro is built for lawn care companies running chemical programs — not adapted from a field service tool designed for plumbers. Every feature works the way lawn care actually works.</p>

...
export const metadata = {
  title: 'Price Spray Services by Square Foot or Linear Foot | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Pricing</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro stores property sq ft and linear footage on every account and calculates route revenue automatically in the waiting list — so dispatchers see expected revenue before building a single route.</p>

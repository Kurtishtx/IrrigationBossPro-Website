...
export const metadata = {
  title: 'Scaling Pest Control From 200 to 500 Accounts | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro scales with a pest control business from 50 accounts to 500 without changing platforms or pricing — the $129/month flat cost stays constant as account volume doubles, triples, and grows.</p>

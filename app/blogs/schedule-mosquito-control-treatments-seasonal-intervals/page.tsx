...
export const metadata = {
  title: 'Schedule Mosquito Control at the Right Intervals | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Mosquito Control Scheduling</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro auto-schedules mosquito treatments at configured intervals from every completion date — so your waiting list is always accurate through peak season without anyone tracking individual due dates.</p>

...
export const metadata = {
  title: 'Reduce Spray Business Cancellations With SMS | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro fires service-specific SMS alerts at every touchpoint automatically — reducing no-access stops, no-show complaints, and early-program cancellations without anyone on your team sending a single manual message.</p>

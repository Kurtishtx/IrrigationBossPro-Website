...
export const metadata = {
  title: 'Managing Multiple Pest Control Technicians | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro dispatches multiple pest control crews simultaneously, tracks completions in real time, and generates per-technician compliance records — from a single office interface with no coordination overhead.</p>

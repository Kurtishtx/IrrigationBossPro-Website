...
export const metadata = {
  title: 'Convert Spray Service Estimates to Scheduled Jobs | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Sales</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro streamlines the spray service estimate workflow from sq ft measurement to program enrollment — with per-sq-ft pricing, instant delivery, and one-click conversion to scheduled recurring service.</p>

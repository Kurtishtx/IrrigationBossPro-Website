...
export const metadata = {
  title: 'Build a Mosquito Spray Route With Circle Mapping | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro&apos;s Lasso circle routing builds mosquito spray routes geographically in under 10 minutes — with real-time sq ft and revenue totals for the selected set before you commit to a single stop.</p>

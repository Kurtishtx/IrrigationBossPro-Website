...
export const metadata = {
  title: 'Property Profiles and Zone Maps That Make Every Scheduled Visit Faster | IrrigationBossPro',
  description: 'Build property profiles and zone maps in IrrigationBossPro so every winterization, start-up, and repair visit starts with the parts and history your crew needs.',
};

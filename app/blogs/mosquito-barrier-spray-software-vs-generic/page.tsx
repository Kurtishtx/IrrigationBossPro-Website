...
export const metadata = {
  title: 'Mosquito Barrier Spray Software vs Generic Tools | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro is purpose-built for barrier spray operations — with the measurement fields, interval scheduling, circle routing, compliance logging, and SMS automation that generic scheduling tools can&apos;t replicate.</p>

...
export const metadata = {
  title: 'Handle Overdue Mosquito Control Treatments | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Account Management</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro surfaces mosquito overdue accounts with days-past-due indicators in both the waiting list and map view — so dispatchers route the most behind customers first and recover from weather delays before protection gaps become customer complaints.</p>

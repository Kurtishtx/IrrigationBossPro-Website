...
export const metadata = {
  title: 'Lawn Care Route Optimization: Cut Drive Time | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro builds optimized routes from your waiting list using map-based stop selection and automatic drive order sequencing. Stop leaving stops on the table.</p>

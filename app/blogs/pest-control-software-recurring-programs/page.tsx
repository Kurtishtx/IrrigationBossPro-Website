...
export const metadata = {
  title: 'Pest Control Software for Recurring Programs | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Software Strategy</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro is purpose-built for pest control companies running quarterly, bi-monthly, and monthly recurring programs — with interval-based auto-scheduling, compliance log integration, and a waiting list that surfaces every due account automatically.</p>

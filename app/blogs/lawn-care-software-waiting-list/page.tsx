...
export const metadata = {
  title: 'Managing the Lawn Care Waiting List Every Morning | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro&apos;s waiting list surfaces every due lawn care account automatically — with sq ft by service type, expected revenue, and a map view for circle routing — so every morning starts from a complete picture of the day&apos;s work.</p>

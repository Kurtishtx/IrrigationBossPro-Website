...
export const metadata = {
  title: 'Pest Control vs Generic Field Service Software | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          <h3>Generic field service software works for 50 trades. IrrigationBossPro is built for yours.</h3>

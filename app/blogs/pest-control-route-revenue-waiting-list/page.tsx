...
export const metadata = {
  title: 'See Pest Control Route Revenue Before Dispatch | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Revenue Management</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro shows expected revenue, total sq ft, program type breakdown, and overdue count for any area you circle on the waiting list map before a single stop is added to a route.</p>

...
export const metadata = {
  title: 'Interior and Exterior Pest Control Treatment Logs | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro supports multi-product visit logging with separate compliance entries per application zone, each with its own EPA reg number, treatment area checklist, and re-entry interval from the product library.</p>

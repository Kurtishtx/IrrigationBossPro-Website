...
export const metadata = {
  title: 'Fertilizer Software vs Lawn Care Scheduling Tools | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Software &amp; Tools</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro tracks rounds, logs EPA reg numbers, sends re-entry interval SMS, and organizes your waiting list by round — built specifically for companies running multi-round fertilizer programs.</p>

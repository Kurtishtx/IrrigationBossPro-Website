...
export const metadata = {
  title: 'Pre-Emergent vs Post-Emergent Weed Control | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Weed Control Scheduling</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro tracks pre-emergent and post-emergent rounds as separate service types with separate queues, compliance logs, and SMS templates so neither program interferes with the other.</p>

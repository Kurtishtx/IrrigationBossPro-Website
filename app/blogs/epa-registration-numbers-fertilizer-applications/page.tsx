...
export const metadata = {
  title: 'EPA Reg Numbers on Fertilizer Applications | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Compliance &amp; Regulations</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro stores EPA registration numbers on your product records and auto-populates them on every compliance log your technicians submit in the field.</p>

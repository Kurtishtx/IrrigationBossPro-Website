...
export const metadata = {
  title: 'EPA Compliance Records for Pest Control Companies | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Compliance</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro&apos;s field logging form captures all required EPA compliance fields via the product library — EPA reg numbers, rates, re-entry intervals, treatment areas, and weather conditions — submitted at the property and available for inspection in seconds.</p>

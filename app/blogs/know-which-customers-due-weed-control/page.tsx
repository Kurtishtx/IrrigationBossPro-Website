...
export const metadata = {
  title: 'Know Which Customers Are Due for Weed Control | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Scheduling Visibility</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro auto-populates your waiting list when each account becomes due, organized by service type with sq ft totals — so your morning routing starts with complete visibility, not manual account review.</p>

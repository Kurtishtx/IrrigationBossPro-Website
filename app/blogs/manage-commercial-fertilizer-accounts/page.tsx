...
export const metadata = {
  title: 'Manage Commercial Fertilizer Alongside Residential | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Commercial Accounts</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro holds multiple properties per client, each with their own program, compliance logs, sq ft, and service history — with combined invoicing and a single communication channel per client.</p>

...
export const metadata = {
  title: 'Quarterly vs Bi-Monthly Pest Control Programs | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro auto-schedules quarterly accounts at 90 days and bi-monthly accounts at 60 days from each completion date, with separate SMS templates and waiting list filters for each program type.</p>

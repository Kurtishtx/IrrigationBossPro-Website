...
export const metadata = {
  title: 'Chemical Application Tracking: Lawn Care Software | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro&apos;s chemical tracking captures every application through the field log completion workflow and makes all records available in a date-range report — printable for inspections in under 3 minutes.</p>

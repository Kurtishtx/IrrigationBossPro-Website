...
export const metadata = {
  title: 'What Lawn Care Customers Expect on Every Visit | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro fires before, during, and after alerts automatically for every stop — so your customers always know what&apos;s happening without your office sending a single text.</p>

...
export const metadata = {
  title: 'Handle Overdue Pest Control Treatments | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro flags overdue pest control accounts by days past due in both the waiting list and map view, so dispatchers route them first without manually reviewing every account for gap status.</p>

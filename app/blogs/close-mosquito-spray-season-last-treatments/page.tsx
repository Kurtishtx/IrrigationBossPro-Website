...
export const metadata = {
  title: 'How to Close a Mosquito Spray Season | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro ties season close to treatment completion events — so the last-treatment message, renewal prompt, and annual compliance report all flow from the same operational workflow.</p>

...
export const metadata = {
  title: 'Managing 21-Day Interval Mosquito Programs | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro auto-advances the next treatment date from each completion — so the 21-day cycle runs itself across your entire customer base without manual rebooking.</p>

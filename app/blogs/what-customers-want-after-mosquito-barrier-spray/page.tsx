...
export const metadata = {
  title: 'What Customers Want After Mosquito Barrier Spray | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro fires a post-service mosquito confirmation with product-specific REI, explicit children and pet instructions, and next treatment date — automatically, within seconds of the compliance log submission.</p>

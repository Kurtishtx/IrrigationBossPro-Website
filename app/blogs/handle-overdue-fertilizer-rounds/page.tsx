...
export const metadata = {
  title: 'How to Handle Overdue Fertilizer Rounds | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Retention &amp; Scheduling</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro flags overdue accounts in your waiting list the day after they become past due — so you can route them immediately and contact customers proactively before the relationship is at risk.</p>

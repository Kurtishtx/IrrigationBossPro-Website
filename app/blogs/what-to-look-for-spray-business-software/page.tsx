...
export const metadata = {
  title: 'What to Look for in Spray Business Software | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Buying Guide</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro answers all five correctly — auto-scheduling from completion dates, product library compliance logs, automatic service-specific SMS alerts, and a waiting list map built for spray business dispatching.</p>

...
export const metadata = {
  title: 'Build a Weekly Lawn Care Schedule That Works | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Scheduling &amp; Operations</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro gives you a live waiting list, map-based route building, and automatic drive order optimization to turn weekly scheduling into a 45-minute process instead of an all-day headache.</p>

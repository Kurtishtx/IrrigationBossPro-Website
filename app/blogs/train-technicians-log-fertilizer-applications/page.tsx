...
export const metadata = {
  title: 'Train Technicians to Log Fertilizer Applications | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Field Operations &amp; Training</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro&apos;s mobile compliance log pre-fills property data, EPA reg numbers, and application rates so your techs spend less than a minute on compliance logging at every stop.</p>

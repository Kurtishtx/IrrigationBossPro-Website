...
export const metadata = {
  title: 'Manage Broadleaf Weed Control With Fertilizer | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro runs multi-program accounts with independent round tracking, separate compliance logs, and coordinated customer SMS for every service combination your customers enroll in.</p>

...
export const metadata = {
  title: 'Pest Control Software: Payment Collection | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro&apos;s card-on-file billing charges customers automatically when each pest control treatment is logged — with automated declined payment alerts and invoice-based billing for customers who prefer it.</p>

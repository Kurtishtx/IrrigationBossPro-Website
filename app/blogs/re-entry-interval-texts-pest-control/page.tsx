...
export const metadata = {
  title: 'Re-Entry Interval Texts After Pest Control Visits | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro fires post-service SMS with the product-specific REI from the compliance log automatically on every stop — correct interval, correct customer, zero manual sends required.</p>

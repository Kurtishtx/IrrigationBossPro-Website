...
export const metadata = {
  title: 'Mosquito Treatments as a Pest Control Add-On | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Program Development</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro supports multiple simultaneous programs per customer account, so mosquito add-ons schedule independently from quarterly or bi-monthly base programs without any scheduling interference.</p>

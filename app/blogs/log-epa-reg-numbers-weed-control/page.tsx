...
export const metadata = {
  title: 'Log EPA Reg Numbers for Weed Control Products | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Compliance &amp; Field Logging</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro&apos;s product library pre-fills EPA reg numbers, application rates, and re-entry intervals when a technician selects a product in the field — eliminating manual entry and the errors that come with it.</p>

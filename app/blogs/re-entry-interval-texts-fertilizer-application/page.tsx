...
export const metadata = {
  title: 'Re-Entry Interval After Fertilizer Applications | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro triggers re-entry interval SMS from the product record the moment a technician submits their compliance log — product-specific, customer-specific, and completely automatic.</p>

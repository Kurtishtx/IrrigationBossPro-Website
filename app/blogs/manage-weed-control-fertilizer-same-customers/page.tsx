...
export const metadata = {
  title: 'Weed Control and Fertilizer for the Same Customers | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Multi-Program Management</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro shows all active service programs under each customer account so the dispatcher always knows what&apos;s due for each customer, whether it&apos;s one service or two, without cross-referencing separate lists.</p>

...
export const metadata = {
  title: 'Pest Control Software: Estimate to Renewal | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro manages the full pest control customer lifecycle — from first estimate through annual renewal — with automated touchpoints at every stage so customers are retained without constant manual effort.</p>

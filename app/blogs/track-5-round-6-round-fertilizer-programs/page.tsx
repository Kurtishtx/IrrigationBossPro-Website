...
export const metadata = {
  title: 'Track 5-Round and 6-Round Fertilizer Programs | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Fertilizer Programs</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro tracks every round per property automatically — advancing the count after each completed visit so your waiting list always shows exactly who&apos;s due for what round and when.</p>

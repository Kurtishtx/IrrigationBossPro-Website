...
export const metadata = {
  title: 'Set Up a New Lawn Care Customer in Software | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro&apos;s new customer setup flow creates a complete, active account in under 10 minutes — with sq ft data, package services, and automatic waiting list placement from the first completion forward.</p>

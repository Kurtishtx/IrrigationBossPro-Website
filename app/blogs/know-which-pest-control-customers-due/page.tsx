...
export const metadata = {
  title: 'Know Which Pest Control Customers Are Due | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Waiting List Management</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro calculates next due dates from every completion and surfaces all due pest control accounts in a filterable, map-view waiting list — so dispatchers build routes from geography, not from account-by-account manual review.</p>

...
export const metadata = {
  title: 'Pest Control Estimates Into Recurring Programs | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro converts accepted pest control estimates directly to active recurring programs — no re-entry, no setup delay, no gap between &quot;yes&quot; and first service scheduling.</p>

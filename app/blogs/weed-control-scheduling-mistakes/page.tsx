...
export const metadata = {
  title: 'The Biggest Weed Control Scheduling Mistakes | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Scheduling Best Practices</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro&apos;s separate service type queues, auto-rescheduling, and immediate skip re-queue prevent every one of these mistakes from happening in the first place.</p>

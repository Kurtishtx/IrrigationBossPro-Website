...
export const metadata = {
  title: 'Automated SMS Alerts for Mosquito Control Visits | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Customer Communication</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro fires all three mosquito control customer alerts automatically — day-before from dispatch, on-the-way from route transit, and post-service with the actual REI from the compliance log — without your team sending a single message manually.</p>

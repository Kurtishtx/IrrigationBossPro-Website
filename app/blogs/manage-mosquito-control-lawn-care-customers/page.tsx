...
export const metadata = {
  title: 'Manage Mosquito Control for Lawn Care Customers | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Multi-Service Management</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro tracks mosquito and lawn care programs as independent scheduling tracks under the same customer account — each auto-scheduling from its own interval, each surfacing in the waiting list when due.</p>

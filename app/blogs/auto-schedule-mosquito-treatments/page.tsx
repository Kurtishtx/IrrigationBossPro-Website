...
export const metadata = {
  title: 'Auto-Schedule Mosquito Treatments After Each Visit | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Scheduling Automation</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro auto-schedules the next mosquito treatment from every completion date at your configured interval — keeping every customer&apos;s program running all season without manual rebooking between visits.</p>

...
export const metadata = {
  title: 'Granular vs Liquid Fertilizer Application Tracking | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Compliance &amp; Application Logging</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro&apos;s mobile compliance log adapts to granular or liquid application types and pre-fills calculations from stored sq ft data so every record is complete before the tech leaves the property.</p>

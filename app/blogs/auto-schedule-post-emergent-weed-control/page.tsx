...
export const metadata = {
  title: 'Auto-Schedule Post-Emergent Weed Control Rounds | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro auto-populates the next round on your waiting list the moment a tech marks a visit complete — at your configured interval, for every program customer, with zero office action required.</p>

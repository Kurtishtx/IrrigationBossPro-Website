...
export const metadata = {
  title: 'Train Technicians to Log Weed Control Applications | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Team &amp; Training</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro&apos;s mobile logging form pre-fills product data, EPA reg numbers, and re-entry intervals from the product library so technicians confirm rather than enter — making at-property compliance logging fast enough to be a habit on every stop.</p>

...
export const metadata = {
  title: 'Set Up Recurring Pest Control Programs in Software | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro configures each pest control program interval at the service level so quarterly, bi-monthly, and monthly accounts all auto-schedule from their actual completion dates without any manual calculation between visits.</p>

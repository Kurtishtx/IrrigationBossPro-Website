...
export const metadata = {
  title: 'Know When Customers Are Due for Fertilizer Rounds | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Scheduling &amp; Program Management</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro&apos;s round-organized waiting list calculates every customer&apos;s next due date automatically and surfaces them at the right time — organized by round, service type, and sq ft totals.</p>

...
export const metadata = {
  title: 'Mosquito Spray Software: Season Start and Shutdown | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro handles mosquito spray seasonal startup and shutdown through the package plan structure — activating and deactivating programs systematically with automated communication at every seasonal touchpoint.</p>

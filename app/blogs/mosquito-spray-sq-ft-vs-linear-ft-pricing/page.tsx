...
export const metadata = {
  title: 'Mosquito Spray: Sq Ft vs Linear Ft Pricing | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro tracks mosquito control sq ft and linear ft separately per property, totals both on the waiting list, and supports per-unit pricing for each — so your pricing model fits your service model exactly.</p>

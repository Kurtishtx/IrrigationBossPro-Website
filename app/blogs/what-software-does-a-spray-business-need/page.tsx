...
export const metadata = {
  title: 'What Software Does a Spray Business Actually Need? | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro is built specifically for spray companies applying chemical treatments on recurring programs — the five features above, done exceptionally well, at $129/month flat.</p>

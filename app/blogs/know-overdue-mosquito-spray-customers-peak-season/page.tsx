...
export const metadata = {
  title: 'Overdue Mosquito Spray Customers During Peak Season | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro&apos;s waiting list sorts by due date automatically — so overdue mosquito spray accounts surface at the top of the dispatcher&apos;s list every morning without any manual tracking or reporting.</p>

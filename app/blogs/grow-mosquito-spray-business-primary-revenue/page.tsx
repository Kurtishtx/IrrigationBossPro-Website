...
export const metadata = {
  title: 'Grow a Mosquito Spray Business to Primary Revenue | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro is built for the full arc of a mosquito spray business — from 20 accounts as an add-on to 300 accounts as the primary revenue driver. Same platform. Same workflow. Scales with you.</p>

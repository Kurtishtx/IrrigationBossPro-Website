...
export const metadata = {
  title: 'Fertilizer Application Rates: Compliance Logging | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Compliance &amp; Logging</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro pre-fills application rate calculations from stored sq ft data and standard rates so your technicians submit accurate, complete compliance logs from the field in under 60 seconds.</p>

...
export const metadata = {
  title: 'Auto-Schedule Fertilizer Rounds After Each Visit | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro auto-schedules the next fertilizer round the moment a technician marks the current one complete — no office action required, all season long.</p>

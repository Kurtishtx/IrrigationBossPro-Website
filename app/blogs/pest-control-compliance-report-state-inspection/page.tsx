...
export const metadata = {
  title: 'Pull a Pest Control Compliance Report in Seconds | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro&apos;s chemical compliance report filters by date, product, property, or technician — and produces a print-ready structured report in seconds for any state inspection request.</p>

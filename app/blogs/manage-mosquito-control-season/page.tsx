...
export const metadata = {
  title: 'Manage the Mosquito Control Season Start to Finish | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Seasonal Operations</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro handles seasonal mosquito program enrollment, 21-day auto-scheduling through peak season, overdue flagging during weather disruptions, and season-close management — all from the same waiting list and dispatch workflow.</p>

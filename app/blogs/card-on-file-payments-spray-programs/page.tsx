...
export const metadata = {
  title: 'Card-on-File Payments for Recurring Spray Programs | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Payments</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro integrates card-on-file payment processing so spray businesses collect payment the day of each service — automatically, after every completed compliance log submission.</p>

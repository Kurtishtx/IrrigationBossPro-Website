...
export const metadata = {
  title: 'How Pest Control Software Handles Re-Service Calls | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro handles re-service calls as a distinct one-time service — tracked, logged, and dispatched without affecting the recurring package plan interval or treatment count.</p>

...
export const metadata = {
  title: 'Know Your Route Revenue Before You Leave the Lot | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro shows total waiting list revenue, selected-route revenue, and per-service-type breakdowns before dispatch — so every daily production decision is made from data, not from a headcount of stops.</p>

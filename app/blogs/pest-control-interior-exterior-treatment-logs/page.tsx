...
export const metadata = {
  title: 'Pest Control Interior and Exterior Treatment Logs | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro&apos;s field log captures treatment areas by checkbox and supports multiple products per visit — so interior and exterior treatments are recorded accurately and separately within the same service event.</p>

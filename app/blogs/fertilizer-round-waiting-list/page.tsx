...
export const metadata = {
  title: 'What Is a Fertilizer Round Waiting List? | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro&apos;s round-organized waiting list shows pending customers by round number, service type, and total sq ft — so every morning starts with complete visibility, not a guessing game.</p>

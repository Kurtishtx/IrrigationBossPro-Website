...
export const metadata = {
  title: 'Re-Entry Interval After Mosquito Barrier Spray | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro fires post-service SMS with the REI pulled directly from the applied product in the compliance log — correct interval, specific to what was actually sprayed, delivered before the technician leaves the driveway.</p>

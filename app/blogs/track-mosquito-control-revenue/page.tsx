...
export const metadata = {
  title: 'Track Mosquito Control Revenue by Route and Type | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro tracks mosquito control revenue at the route, technician, and program level — with pre-route revenue visible in the waiting list before a single stop is dispatched.</p>

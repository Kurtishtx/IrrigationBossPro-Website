...
export const metadata = {
  title: 'Add Mosquito Spraying to Your Existing Business | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro supports mosquito control sq ft, mosquito control linear ft, lawn care, pest control, and more on the same property — so adding mosquito spray to an existing book is a service type addition, not a software overhaul.</p>

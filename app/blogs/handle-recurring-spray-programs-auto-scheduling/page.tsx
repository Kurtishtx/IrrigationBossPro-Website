...
export const metadata = {
  title: 'Auto-Schedule Recurring Spray Programs | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Automation</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro auto-schedules the next spray visit from every completion across all service types and program intervals — so your waiting list is always current without your office touching anything between visits.</p>

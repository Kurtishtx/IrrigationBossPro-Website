...
export const metadata = {
  title: 'Track Spray Business Revenue by Service Type | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Revenue Tracking</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro tracks spray business revenue at the service-type, route, and crew level — with pre-route revenue visibility in the waiting list so dispatchers optimize output before the trucks leave the shop.</p>

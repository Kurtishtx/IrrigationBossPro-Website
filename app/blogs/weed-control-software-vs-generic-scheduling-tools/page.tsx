...
export const metadata = {
  title: 'Weed Control Software vs Generic Scheduling Tools | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Software Comparison</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro handles seasonal timing windows, multi-program accounts, field-submitted compliance logs with product libraries, and product-specific re-entry SMS — features that don&apos;t exist in generic field service tools.</p>

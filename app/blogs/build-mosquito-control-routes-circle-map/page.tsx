...
export const metadata = {
  title: 'Mosquito Control Route Building With Circle Map | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro&apos;s circle map routing shows every mosquito treatment due in any area you select — with overdue priority, drive order optimization, and route dispatch to technician phones before the first stop.</p>

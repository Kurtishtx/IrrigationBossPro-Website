...
export const metadata = {
  title: 'Know Which Pest Control Customers Need Renewal | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro&apos;s package tracking surfaces renewal-ready accounts automatically — so every pest control customer gets renewal outreach at exactly the right time, and none of them lapse from an oversight.</p>

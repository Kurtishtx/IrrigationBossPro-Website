...
export const metadata = {
  title: 'Build Lawn Care Routes in 30 Minutes | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Scheduling &amp; Routing</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro gives you a map-based waiting list, one-click dispatch, and automatic drive order optimization — built for lawn care companies running recurring programs.</p>

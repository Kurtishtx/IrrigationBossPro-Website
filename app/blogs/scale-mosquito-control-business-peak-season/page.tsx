...
export const metadata = {
  title: 'Scale a Mosquito Control Business at Peak Season | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Scaling</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro gives mosquito companies the scheduling accuracy and routing efficiency to handle peak season volume, weather delays, and account growth without losing stops or falling behind on 21-day intervals.</p>

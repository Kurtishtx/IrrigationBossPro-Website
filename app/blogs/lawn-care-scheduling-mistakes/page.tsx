...
export const metadata = {
  title: 'The Biggest Lawn Care Scheduling Mistakes | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro automates your waiting list, route building, dispatch, and customer alerts so nothing falls through the cracks.</p>

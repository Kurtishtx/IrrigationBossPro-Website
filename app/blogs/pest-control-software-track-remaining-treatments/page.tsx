...
export const metadata = {
  title: 'Pest Control Software: Track Remaining Treatments | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro&apos;s package plan tracking shows remaining treatments per account across every active program — so renewal timing is a system output, not a manual follow-up task.</p>

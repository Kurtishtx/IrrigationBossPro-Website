...
export const metadata = {
  title: 'Lawn Care vs Generic Field Service Software | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro is purpose-built for lawn care, mosquito spray, fertilizer, and pest control companies running multi-round programs — not a generic field service tool repurposed for your industry.</p>

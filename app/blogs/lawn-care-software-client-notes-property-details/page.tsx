...
export const metadata = {
  title: 'Property Notes and Details in Lawn Care Software | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro property notes, custom fields, and tags give every technician complete property context on every dispatched stop — no phone calls to the office required.</p>

...
export const metadata = {
  title: 'Train Techs to Log Mosquito Control Applications | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro&apos;s compliance log pre-fills EPA reg numbers, rates, and re-entry intervals from the product library — so mosquito technicians submit complete, accurate logs in under 90 seconds per stop, every stop.</p>

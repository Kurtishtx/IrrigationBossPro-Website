...
export const metadata = {
  title: 'Mosquito Barrier Spray: Customer Re-Entry Guide | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro sends the re-entry interval message automatically when the technician logs each completion in the field — so your customers are informed before they&apos;ve even had a chance to wonder whether it&apos;s safe to go back outside.</p>

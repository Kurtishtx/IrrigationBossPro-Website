...
export const metadata = {
  title: 'Build a Mosquito Control Business Year Over Year | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Business Growth</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro gives mosquito control businesses the auto-scheduling precision, overdue recovery tools, and customer communication systems that produce high re-enrollment rates and year-over-year account base growth.</p>

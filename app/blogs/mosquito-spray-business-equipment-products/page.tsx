...
export const metadata = {
  title: 'Mosquito Spray Business: Equipment and Products | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro&apos;s chemical tracking report records every product application with the product mix, rate, and EPA registration number — giving you a compliant application log from each technician&apos;s mobile field entries.</p>

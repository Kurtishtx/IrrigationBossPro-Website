...
export const metadata = {
  title: 'Build Spray Routes With Circle Map Route Building | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro&apos;s circle map routing shows every spray stop due in any area you select — with total stops, expected revenue, service type breakdown, and optimized drive order — before you dispatch a single truck.</p>

...
export const metadata = {
  title: 'What Pest Control Auto-Scheduling Looks Like | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro auto-schedules the next pest control visit the moment a tech submits the completion log, so your waiting list is always current without anyone in the office doing anything between visits.</p>

...
export const metadata = {
  title: 'Fertilizer Compliance Logs vs. Spreadsheets | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Compliance &amp; Operations</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro captures field-submitted compliance logs per property per visit — structured, timestamped at the time of application, and exportable as an inspection-ready report on demand.</p>

...
export const metadata = {
  title: 'How to Evaluate Lawn Care Software | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro offers a full free trial with every feature unlocked — no demo-only access, no limits on accounts or routes while evaluating. Try the waiting list, the circle map, the compliance log, and the SMS all on real data.</p>

...
export const metadata = {
  title: 'Track Square Footage for Every Property | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro stores sq ft on every property and uses it to drive waiting list totals, route capacity, chemical logs, and invoicing automatically.</p>

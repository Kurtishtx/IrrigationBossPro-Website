...
export const metadata = {
  title: 'Lawn Care Software: Route Revenue Before Dispatch | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro&apos;s waiting list shows a live revenue total for all due accounts — filterable by service type, selectable by geographic cluster, updated in real time as the dispatcher builds the route.</p>

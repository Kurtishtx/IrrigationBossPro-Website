...
export const metadata = {
  title: 'Pest Control Re-Entry Interval Compliance | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro sends the accurate re-entry interval from the product library record automatically with every post-service SMS — so REI communication is always correct and always compliant without any manual intervention.</p>

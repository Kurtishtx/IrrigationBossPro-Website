...
export const metadata = {
  title: 'Schedule Fall Fertilizer and Winterizer Rounds | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro auto-queues fall rounds from summer completion dates and shows you real-time waiting list visibility so you can track every pending fall treatment and route them before the window closes.</p>

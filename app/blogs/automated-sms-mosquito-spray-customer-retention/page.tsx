...
export const metadata = {
  title: 'How Automated SMS Retains Mosquito Spray Customers | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro fires pre-service and post-service SMS from dispatch and completion events automatically — so professional customer communication happens on every route day without any manual effort from the office.</p>

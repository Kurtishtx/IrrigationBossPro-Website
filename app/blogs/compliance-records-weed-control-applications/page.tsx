...
export const metadata = {
  title: 'Compliance Records for Weed Control Applications | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro captures all required compliance fields at the time of application via mobile field logging — and produces inspection-ready reports in seconds for any date range, property, or product.</p>

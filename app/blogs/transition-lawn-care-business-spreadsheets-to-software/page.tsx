...
export const metadata = {
  title: 'Move Lawn Care From Spreadsheets to Software | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro is designed for fast transitions — with package plan templates, CSV import support, and a setup process that can be completed in one active season without disrupting a single service route.</p>

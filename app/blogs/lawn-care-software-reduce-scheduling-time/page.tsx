...
export const metadata = {
  title: 'How Lawn Care Software Reduces Scheduling Time | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro replaces the scheduling overhead of a manual lawn care operation with automated waiting list, circle map routing, completion-date auto-scheduling, and automated SMS — saving 3+ hours of scheduling work per day.</p>

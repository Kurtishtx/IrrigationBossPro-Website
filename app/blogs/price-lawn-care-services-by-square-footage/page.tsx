...
export const metadata = {
  title: 'Price Lawn Care Services by Square Footage | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro stores sq ft on every property and calculates expected revenue per stop and per route so you can see the profitability of your schedule before it runs.</p>

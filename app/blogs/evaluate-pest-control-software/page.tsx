...
export const metadata = {
  title: 'How to Evaluate Pest Control Software | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Pest Control Software</p>
        ...
        <div className="blog-cta-box">
          <h3>Auto-scheduling. Product library EPA pre-fill. Automatic REI SMS. Package tracking. Flat pricing. Inspector-ready in 60 seconds. IrrigationBossPro says yes to all six.</h3>
          <p>IrrigationBossPro is built specifically for recurring pest control operations — try it free for 14 days with every feature unlocked, no credit card required.</p>

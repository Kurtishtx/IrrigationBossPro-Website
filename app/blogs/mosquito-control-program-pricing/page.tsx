...
export const metadata = {
  title: 'Mosquito Control Program Pricing for Retention | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Pricing Strategy</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro tracks mosquito program pricing and customer payment structure by account — with per-sq-ft revenue calculation in the waiting list so route revenue reflects actual program pricing before you build the route.</p>

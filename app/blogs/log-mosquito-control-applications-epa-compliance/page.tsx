...
export const metadata = {
  title: 'Log Mosquito Control Applications: EPA Compliance | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro&apos;s mobile compliance log captures all required mosquito application fields — with product library pre-fill for EPA reg numbers, rates, and re-entry intervals — submitted in the field and searchable in the office immediately.</p>

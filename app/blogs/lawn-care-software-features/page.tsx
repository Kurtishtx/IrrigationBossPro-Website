...
export const metadata = {
  title: 'The Features Every Lawn Care Software Needs | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro has every feature on this list — built for lawn care from the ground up, not adapted from a generic field service tool, at $129/month with no per-feature add-ons.</p>

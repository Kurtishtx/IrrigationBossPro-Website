...
export const metadata = {
  title: 'Add Mosquito Control to Lawn Care or Pest Control | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Program Expansion</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro supports multiple simultaneous programs per customer account so mosquito service schedules on its own 21-day cycle without interfering with base lawn care or pest control programs.</p>

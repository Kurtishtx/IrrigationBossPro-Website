...
export const metadata = {
  title: 'Reduce Pest Control Cancellations With SMS Alerts | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Customer Retention</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro fires pre-visit SMS reminders and post-service confirmations with product-specific re-entry intervals automatically — no manual sends, no missed alerts, consistent communication on every visit.</p>

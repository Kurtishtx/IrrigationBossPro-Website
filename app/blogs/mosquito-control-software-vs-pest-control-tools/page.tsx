...
export const metadata = {
  title: 'Mosquito Control Software vs Pest Control Tools | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Software Selection</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro is built for mosquito control programs — with 21-day auto-scheduling from completion dates, product library compliance logging, and automatic REI SMS — not adapted from a generic pest control job board.</p>

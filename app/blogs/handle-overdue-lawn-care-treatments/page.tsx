...
export const metadata = {
  title: 'Handle Overdue Lawn Care Treatments | IrrigationBossPro',
  ...
  return (
    <BlogShell>
      <article className="blog-article">
        <p className="blog-meta">IrrigationBossPro Blog &mdash; Scheduling &amp; Retention</p>
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro flags overdue treatments in your waiting list automatically so you can prioritize and route them before anyone notices they were missed.</p>

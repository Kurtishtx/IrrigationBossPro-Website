...
export const metadata = {
  title: 'Run a Mosquito Spray Business From One Platform | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro runs a complete mosquito spray operation from one platform — scheduling, routing, compliance, customer communication, and billing all connected at $129/month flat.</p>

...
export const metadata = {
  title: 'Build a Mosquito Control Treatment Waiting List | IrrigationBossPro',
    ...
    <BlogShell>
      <article className="blog-article">
        ...
        <div className="blog-cta-box">
          ...
          <p>IrrigationBossPro&apos;s mosquito waiting list calculates due dates from every completion automatically, surfaces overdue accounts first, and shows expected route revenue for any date range or geographic filter.</p>

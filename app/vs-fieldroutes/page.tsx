  ...
  return (
    <>
      ...
      <div className="hero">
        ...
        <h1>FieldRoutes Won&apos;t Tell You What It Costs Until You&apos;ve Sat Through a Demo.<br /><span>IrrigationBossPro Is $129. Start Today.</span></h1>
        <p>FieldRoutes requires a demo before you can even see pricing. Then an implementation timeline before you can use the software. IrrigationBossPro is $129/month, published right here, with a 14-day free trial you can start in the next 5 minutes — no sales call, no demo, no waiting.</p>
        ...
        <div className="hero-stats">
          <div><div className="hero-stat-val">$129</div><div className="hero-stat-lbl">IrrigationBossPro — Published Price</div></div>
      ...
      <section>
        <div className="centered" style={{maxWidth:'960px', margin:'0 auto'}}>
          ...
          <h2 className="section-title">IrrigationBossPro vs FieldRoutes</h2>
      ...
      <section id="lasso" className="dark-section">
        <div className="highlight-row">
          <div className="highlight-text">
            ...
            <h2 style={{color:'#fff'}}>FieldRoutes Has Route Optimization.<br />IrrigationBossPro Has Lasso.</h2>
          ...
          <div className="highlight-row">
            <div className="highlight-visual" style={{flex:1.5, minWidth:'280px'}}>
              <div className="steps-visual">
                ...
                <div className="step-row">
                  <div className="step-row-title">IrrigationBossPro</div>
                  <div className="step-item">
            ...
            <div className="highlight-text" style={{flex:1, minWidth:'280px'}}>
              ...
              <p>FieldRoutes hides their pricing behind a required demo. That means a sales presentation, a callback from a rep, a negotiation, and an implementation timeline before you can run a single route. IrrigationBossPro costs $129/month. You can see it. You can start it. Right now.</p>
      ...
      <section>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto 56px'}}>
          ...
          <h2 className="section-title">FieldRoutes Is Built for Large Pest Control Operations. IrrigationBossPro Fits Your Business Right Now.</h2>
        ...
        <div className="simple-grid">
          <div className="simple-card"><div className="simple-num">01</div><h3>Start Today — Not After a Demo</h3><p>IrrigationBossPro has a 14-day free trial you can start right now without talking to anyone. FieldRoutes requires a demo before you can even see a price. If you want to be operational this week, you need software that lets you start this week.</p></div>
          <div className="simple-card"><div className="simple-num">02</div><h3>$129. Always. No Custom Quotes.</h3><p>FieldRoutes pricing varies based on your operation size — you negotiate it during the sales process. IrrigationBossPro is $129/month. There&apos;s no call to make, no rep to wait for, no pricing package to compare. Just $129.</p></div>
          ...
          <div className="simple-card"><div className="simple-num">04</div><h3>Month-to-Month — No Lock-In</h3><p>IrrigationBossPro is month-to-month. No annual contract required. FieldRoutes uses annual agreements. If the software doesn&apos;t work for your business, you shouldn&apos;t be stuck in it for a year. IrrigationBossPro earns your business every month.</p></div>
        </div>
      </section>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto'}}>
          ...
          <p className="section-sub">FieldRoutes won&apos;t tell you their price until you talk to sales. IrrigationBossPro is $129. Start today.</p>
        </div>
      ...
      <div className="cta-band">
        <h2>Done Waiting for a Sales Rep to Tell You What Software Costs?<span>IrrigationBossPro Is $129. Start Right Now.</span></h2>
        <p>Try IrrigationBossPro free for 14 days. No credit card required. No demo required.</p>
        <div className="hero-btns">

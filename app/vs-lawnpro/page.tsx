    ...
    <>
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        :root { --purple-dark:#0f1720; --purple-mid:#0d141c; --purple-deep:#1f2937; --orange:#84cc16; --orange-dark:#4d7c0f; --text:#1a1a2e; --muted:#555; --light-bg:#f8f7fc; --border:#e4e0f0; }
        ...
        .prt { color: #79bb15; font-size: 12px; font-weight: 600; }
        ...
        .lp-tier.same-price { border-color: #79bb15; background: #dbf0ba; }
        ...
        .lp-tier-locked { font-size: 11px; color: #79bb15; font-weight: 600; background: #d3edab; border: 1px solid #a9dc5c; border-radius: 4px; padding: 2px 8px; white-space: nowrap; }
        .same-price-badge { background: #79bb15; color: #fff; font-size: 10px; font-weight: 700; border-radius: 4px; padding: 2px 6px; text-transform: uppercase; letter-spacing: .5px; }
        .sbp-contrast { background: linear-gradient(135deg, var(--purple-deep) 0%, #263445 100%); border-radius: 10px; padding: 16px 18px; border: 2px solid rgba(132,204,22,.3); }
        ...
        .sbp-always { background: linear-gradient(135deg, var(--purple-deep) 0%, #263445 100%); border: 2px solid rgba(132,204,22,.3); border-radius: 10px; padding: 16px 18px; }
      ...
      <div className="hero">
        ...
        <h1>LawnPro Grow Is $129/Month — With a 7-Employee Cap, No SMS, and No Card-on-File Payments.<br /><span>IrrigationBossPro Is $129 With Unlimited Users, SMS, and Payments Included.</span></h1>
        <p>LawnPro Grow matches IrrigationBossPro&apos;s price but caps you at 7 employees, locks two-way SMS behind the $249 Plus plan, and doesn&apos;t include card-on-file auto-charge. IrrigationBossPro is the same $129 — with no caps, no locked features, and everything spray businesses actually need included.</p>
        ...
        <div className="hero-stats">
          ...
          <div><div className="hero-stat-val">Unlimited</div><div className="hero-stat-lbl">IrrigationBossPro Users — Always</div></div>
          ...
          <div className="highlight-row">
            <div className="highlight-visual" style={{flex:1.5, minWidth:'280px'}}>
              ...
              <div className="sbp-contrast">
                <div className="sbp-contrast-label">IrrigationBossPro at $129 — What You Actually Get</div>
            ...
            <div className="highlight-text" style={{flex:1, minWidth:'280px'}}>
              ...
              <p>LawnPro Grow costs $129/month — the same as IrrigationBossPro. But it caps your team at 7 employees, locks two-way text messaging behind the $249 Plus plan, and doesn&apos;t include card-on-file auto-charge at any price below Plus.</p>
              <p>IrrigationBossPro is $129/month with unlimited users, SMS, card-on-file payments, lasso routing, sq ft waiting list, and chemical compliance logs — all included. No tier upgrades required.</p>
      ...
      <section>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto 48px'}}>
          ...
          <h2 className="section-title">To Get SMS and Card-on-File at LawnPro, You Pay $249/Month. IrrigationBossPro Includes Both at $129.</h2>
          <p className="section-sub" style={{maxWidth:'720px', marginLeft:'auto', marginRight:'auto'}}>LawnPro locks several critical features behind the $249 Plus plan. On top of that, you&apos;re still capped at 15 employees. IrrigationBossPro includes all of these at $129 with no caps.</p>
        </div>
        <div style={{maxWidth:'1100px', margin:'0 auto'}}>
          <div className="highlight-row reverse">
            <div className="highlight-text" style={{flex:1, minWidth:'280px'}}>
              <span className="section-label">Always Included at $129</span>
              <h2>IrrigationBossPro Doesn&apos;t Have Plus Plans. One Price Gets You Everything.</h2>
              <p>At LawnPro, you start at $129/month and realize the features your spray business needs are Plus-only. You&apos;re pushed to $249/month — nearly double. At IrrigationBossPro, $129 is the only plan because one plan is all you need.</p>
              <ul className="check-list">
            ...
            <div className="highlight-visual" style={{flex:1.5, minWidth:'280px'}}>
              ...
              <div className="sbp-always">
                <div className="sbp-always-label">IrrigationBossPro at $129 — Always Included</div>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'960px', margin:'0 auto 48px'}}>
          ...
          <h2 className="section-title">IrrigationBossPro vs LawnPro — Feature by Feature</h2>
          <p className="section-sub" style={{maxWidth:'720px', marginLeft:'auto', marginRight:'auto'}}>A complete look at what&apos;s included at each price point. LawnPro was built for mowing businesses — IrrigationBossPro was built for spray.</p>
        </div>
          ...
          <table className="compare-table">
            <thead>
              <tr>
                ...
                <th className="sbp-col" style={{width:'22%'}}>IrrigationBossPro $129</th>
      ...
      <section>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto 56px'}}>
          ...
          <h2 className="section-title">LawnPro Was Built for Mowing Routes. IrrigationBossPro Was Built for Spray.</h2>
          <p className="section-sub" style={{maxWidth:'720px'}}>LawnPro is a solid choice for lawn mowing businesses. But spray businesses have specific requirements — sq ft tracking, chemical compliance, waiting list management by service type — that LawnPro doesn&apos;t address at any tier. IrrigationBossPro was built for exactly those needs.</p>
        </div>
        <div className="simple-grid">
          <div className="simple-card"><div className="simple-num">01</div><h3>Same Price — More Included</h3><p>LawnPro Grow is $129/month with a 7-employee cap, no SMS, and no card-on-file payments. IrrigationBossPro is $129/month with unlimited users, full SMS, card-on-file auto-charge, lasso routing, sq ft waiting list, and chemical logs — all included from day one.</p></div>
          <div className="simple-card"><div className="simple-num">02</div><h3>No Employee Caps — Ever</h3><p>As your spray business grows, you add trucks and technicians. LawnPro charges $249/month to get to 15 employees, and you&apos;re still capped. IrrigationBossPro never limits your team size — unlimited employees are included in the base $129 price, no upgrade required.</p></div>
          <div className="simple-card"><div className="simple-num">03</div><h3>Spray-Specific Features at Every Tier</h3><p>Sq ft waiting list by service type, lasso circle route selector, chemical compliance logs — LawnPro doesn&apos;t have these at any price tier. They&apos;re core features in IrrigationBossPro because they were built for how spray businesses actually manage recurring treatment schedules.</p></div>
          <div className="simple-card"><div className="simple-num">04</div><h3>14-Day Free Trial — No Card Required</h3><p>IrrigationBossPro has a 14-day free trial with full access. No credit card required. You can see every feature, set up your routes, add your clients, and confirm it&apos;s the right fit before paying anything. LawnPro offers a perpetual free plan with limits but no full-feature trial.</p></div>
        </div>
      </section>
      ...
      <div className="cta-band">
        ...
        <p>IrrigationBossPro is $129/month — the same as LawnPro Grow with unlimited users, SMS, and payments included. Start your free trial today.</p>
        <div className="hero-btns">

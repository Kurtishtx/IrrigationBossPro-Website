    ...
    <>
      ...
      <div style={{background:'var(--purple-dark)', padding:'0 40px 60px', textAlign:'center'}}>
        <img
          ...
          fetchPriority="high"
          decoding="async"
          alt="IrrigationBossPro mosquito control software dashboard showing route scheduling, waiting list, and technician mobile app"
      ...
      <section>
        <div className="highlight-row">
          <div className="highlight-text">
            ...
            <p>Most mosquito control companies run the same customers on a recurring schedule — monthly, every 21 days, every 3 weeks — from spring through fall. IrrigationBossPro is built around that model. When a treatment is complete, the next one automatically goes back on the waiting list at the right interval. No manual rescheduling. No customers falling off the program.</p>
            <p>Sell seasonal mosquito control packages and track exactly how many treatments each customer has left. IrrigationBossPro alerts you before a program expires so you can renew before the season ends — not after.</p>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="highlight-row reverse">
          <div className="highlight-text">
            ...
            <p>Stop pulling up addresses one at a time. Open Lasso, draw a circle over any neighborhood or service zone, and IrrigationBossPro instantly shows you every property with a mosquito control treatment due inside that boundary — customer name, sq ft or linear ft, program type, and route revenue. All of them.</p>
            <p>Select all with one click, let IrrigationBossPro optimize the drive order, and push the route directly to your technician&apos;s phone. A full day of mosquito control routes in minutes — not the first hour of your morning.</p>
            <ul className="check-list">
      ...
      <section>
        <div className="highlight-row">
          <div className="highlight-text">
            ...
            <p>Mosquito control customers have specific questions — when is my technician coming, how long before kids and pets can go back in the yard, was the treatment done today? IrrigationBossPro sends the right message automatically at every step so you never have to field those calls.</p>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto 64px'}}>
          ...
          <p className="section-sub">IrrigationBossPro is built around the way mosquito control companies actually work — recurring programs, zone-based routes, and customers who want to know what&apos;s happening at every step. For a closer look at how 21-day interval scheduling runs automatically all season, read <a href="/blogs/schedule-mosquito-control-treatments-seasonal-intervals" style={{color:'var(--orange)', fontWeight:600}}>How to Schedule Mosquito Control Treatments at the Right Seasonal Intervals</a>.</p>
        </div>
        <div className="steps-grid">
          ...
          <div className="step-box"><div className="step-circle">2</div><h3>Lasso a Treatment Zone</h3><p>Draw a circle on any neighborhood. IrrigationBossPro shows every mosquito control stop due inside — service type, sq ft or linear ft, revenue. Add them all to a route in one click.</p></div>
      ...
      <div className="premium-band">
        ...
        <p>IrrigationBossPro isn&apos;t generic field service software patched to work for mosquito control. It&apos;s built for recurring treatment programs, zone-based routing, compliance logging, and the customer communication that mosquito control companies deal with every single season.</p>
        <div className="premium-grid">
          ...
          <div className="premium-card"><div className="premium-card-icon">📦</div><h4>Seasonal Package Plans</h4><p>Sell seasonal mosquito control packages with treatment count tracking. IrrigationBossPro alerts you before programs expire so you can renew before the season ends.</p></div>
          ...
          <div className="premium-card"><div className="premium-card-icon">👥</div><h4>Unlimited Technicians</h4><p>Run one mosquito control truck or a full fleet. IrrigationBossPro doesn&apos;t charge per user — add every tech in your company, the price stays $129/month.</p></div>
        </div>
      </div>
      ...
      <section style={{background:'#fff'}}>
        <div style={{maxWidth:'860px', margin:'0 auto', padding:'80px 40px'}}>
          ...
          {[
            {q:'Does IrrigationBossPro work for mosquito control businesses?', a:'Yes. IrrigationBossPro is built for recurring spray programs including mosquito control. It handles 21-day auto-interval scheduling, sq ft waiting list routing, chemical compliance logs, and automated SMS — specifically designed for the mosquito control model.'},
            {q:'How does auto-interval scheduling work?', a:'When a mosquito control treatment is logged as complete, IrrigationBossPro automatically adds the next treatment to the waiting list with the correct due date — 21 days later by default. No calendar entry, no rebooking. The account reappears on the waiting list when it\'s due, with all property details pre-populated.'},
            {q:'Can I add mosquito control to an existing lawn care or pest control business?', a:'Yes. IrrigationBossPro manages multiple service types from one account. You can run lawn care, pest control, and mosquito control routes simultaneously, with separate waiting lists by service type and service-specific SMS alert templates.'},
            ...
            {q:'Can I track treatments remaining on a seasonal mosquito package?', a:'Yes. IrrigationBossPro tracks treatments remaining per customer on package programs. When a package is nearing completion, you\'re notified so you can initiate the renewal conversation before the season ends.'},
            {q:'How much does IrrigationBossPro cost?', a:'$129/month, flat. Every feature — routes, compliance logs, SMS alerts, card-on-file payments — is included at one price. No per-user fees, no add-ons. 14-day free trial, no credit card required.'},
          ].map(({q, a}, i, arr) => (
          ...
          <p style={{marginTop:'40px', color:'var(--muted)', fontSize:'15px', lineHeight:1.7}}>IrrigationBossPro handles mosquito control alongside lawn care, pest control, and every other spray service from one platform — <a href="/" style={{color:'var(--orange)', fontWeight:600}}>see the full platform overview</a>.</p>
        </div>
      </section>

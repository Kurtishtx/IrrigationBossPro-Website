  ...
  return (
    <>
      ...
      <div className="hero">
        ...
        <p>IrrigationBossPro tracks 5-round and 6-round fertilizer programs from start to finish. Log product name, EPA reg number, application rate per 1,000 sq ft, and applicator license on every visit. When a round is completed, the next round reschedules itself on the waiting list automatically. $129/month, everything included.</p>
      ...
      <div style={{background:'var(--purple-dark)', padding:'0 40px 60px', textAlign:'center'}}>
        <img
          ...
          fetchPriority="high"
          decoding="async"
          alt="IrrigationBossPro fertilizer software showing round scheduling, sq ft route building, and EPA compliance log on laptop and mobile"
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto 48px'}}>
          ...
          <h2 className="section-title">Whether You Run 5 Rounds or 6, Granular or Liquid — IrrigationBossPro Has You Covered.</h2>
          <p className="section-sub">IrrigationBossPro tracks every fertilizer program type your lawn care company runs — round-by-round scheduling, compliance logging, auto-rescheduling, and automated re-entry SMS — all in one platform at one flat price.</p>
        </div>
        <div className="audience-grid">
          <div className="audience-card">
            <div className="audience-tag">5-Round Programs</div>
            <h3>Classic 5-Round Lawn Fertilizer Program</h3>
            <p>Early spring, late spring, summer, fall, and winterizer — IrrigationBossPro tracks each round, auto-schedules the next when the previous is complete, and logs EPA reg numbers and rates on every application from the technician&apos;s phone.</p>
          </div>
          <div className="audience-card">
            <div className="audience-tag">6-Round Programs</div>
            <h3>6-Round Programs with Pre-Emergent Combo</h3>
            <p>Run a 6-round fertilizer program that includes pre-emergent in rounds 1 and 2? IrrigationBossPro tracks each round individually — different products, different rates, same compliance log format — all under one customer account and one sq ft measurement.</p>
          </div>
          <div className="audience-card">
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="highlight-row reverse">
          <div className="highlight-text">
            ...
            <p>Open Lasso on the map, draw a circle around any neighborhood or service zone, and IrrigationBossPro shows you every property with a fertilizer treatment due inside that boundary — round number, sq ft, and route revenue all visible before you commit to the route.</p>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="highlight-row reverse">
          <div className="highlight-text">
            ...
            <p>IrrigationBossPro sends a day-before service reminder the evening before every fertilizer visit, an on-the-way alert when the tech heads to the property, and a service complete notification with re-entry interval and lawn care instructions automatically when the application log is saved.</p>
            <p>Re-entry interval SMS is especially important for fertilizer programs — customers need to know when it&apos;s safe to bring kids and pets back on the lawn. IrrigationBossPro handles that communication automatically on every visit.</p>
            <ul className="check-list">
          ...
          <div className="highlight-visual">
            <div style={{color:'rgba(255,255,255,.45)', fontSize:'10px', textTransform:'uppercase', letterSpacing:'.8px', marginBottom:'14px'}}>Fertilizer SMS Thread — Sent Automatically by IrrigationBossPro</div>
      ...
      <div className="premium-band">
        ...
        <p>IrrigationBossPro isn&apos;t a generic scheduling tool with fertilizer tags added on. Round tracking, EPA compliance logs, auto-rescheduling, Lasso routing, and re-entry SMS are all built specifically for companies running recurring fertilizer programs.</p>
      ...
      <section style={{background:'#fff'}}>
        <div style={{maxWidth:'860px', margin:'0 auto', padding:'80px 40px'}}>
          ...
          {[
            {q:'Does IrrigationBossPro work for fertilizer businesses?', a:'Yes. IrrigationBossPro handles recurring fertilizer programs from Round 1 through Winterizer — tracking which round each customer is on, routing by sq ft, logging EPA registration numbers and application rates, and sending automated SMS alerts after each application.'},
            {q:'Can I track multiple fertilizer rounds per customer?', a:'Yes. IrrigationBossPro tracks each customer\'s current round, treatments remaining, and next due date. When Round 3 is completed, Round 4 automatically goes back on the waiting list. You always know who is on which round without checking a spreadsheet.'},
            {q:'Does it log EPA registration numbers and application rates for fertilizer compliance?', a:'Yes. IrrigationBossPro stores EPA registration numbers at the product level and captures them on every treatment log. Application rates, product, area treated, and applicator license are recorded per treatment and accessible in a print-ready compliance report.'},
            ...
            {q:'Does IrrigationBossPro send re-entry interval notifications after fertilizer applications?', a:'Yes. Post-service SMS alerts can include re-entry timing — "Please keep pets off treated areas for 2 hours." Alerts fire automatically when the technician logs completion — before the customer has a chance to wonder whether it\'s safe to go outside.'},
            {q:'What does IrrigationBossPro cost for a fertilizer business?', a:'$129/month, flat. All features included — compliance logs, route tools, SMS alerts, card payments. No per-user fees, no add-ons. 14-day free trial, no credit card required.'},
          ].map(({q, a}, i, arr) => (
          ...
          <p style={{marginTop:'40px', color:'var(--muted)', fontSize:'15px', lineHeight:1.7}}>IrrigationBossPro handles fertilizer programs alongside lawn care, weed control, pest control, and mosquito spray — all from one platform — <a href="/" style={{color:'var(--orange)', fontWeight:600}}>see the full platform overview</a>.</p>
        </div>
      </section>

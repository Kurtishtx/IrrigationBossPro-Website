  ...
  return (
    <>
      ...
      <div className="premium-band">
        <h2>Jobber Charges More as You Grow.<br /><span>IrrigationBossPro Charges $59. Period.</span></h2>
        <p>The moment you add your 6th employee on Jobber, you&apos;re bumped to a higher tier. Add more features, pay more. Add more users, pay more. IrrigationBossPro has one price — from $59/month — that covers your entire crew, every feature, forever. No tiers. No per-seat math. No surprises on your invoice.</p>
        ...
        <div className="highlight-row">
          ...
          <div className="highlight-visual">
            ...
            <div className="mock-item">
              ...
              <div><div className="mock-label">IrrigationBossPro</div><div className="mock-sub">Unlimited users — every feature — SMS included</div></div>
            ...
            <div className="mock-item">
              <div className="mock-dot" style={{background:'#84cc16'}}></div>
              <div><div className="mock-label">Jobber Plus</div><div className="mock-sub">Up to 15 users — premium support</div></div>
              <div className="mock-badge" style={{background:'#609411'}}>$529/mo</div>
            </div>
      ...
      <section id="lasso" className="dark-section">
        <div className="highlight-row">
          <div className="highlight-text">
            ...
            <p style={{color:'rgba(255,255,255,.65)'}}>Draw a circle on your service area map and IrrigationBossPro instantly shows every property inside that radius with a service due — total stops, service types, sq ft, all calculated before you schedule a single stop. Jobber has route optimization. That&apos;s completely different from Lasso. No competitor has built anything like this.</p>

  ...
  return (
    <>
      ...
      <div className="hero">
        ...
        <p>CLIP Basic limits you to 40 properties and 1 user. Add users at $20/month each. Add payment processing separately. IrrigationBossPro is $129/month flat — unlimited properties, unlimited users, everything included.</p>
        ...
        <div className="hero-stats">
          ...
          <div><div className="hero-stat-val">Unlimited</div><div className="hero-stat-lbl">IrrigationBossPro Properties</div></div>
          <div><div className="hero-stat-val">$20/mo</div><div className="hero-stat-lbl">CLIP Extra User Fee</div></div>
          <div><div className="hero-stat-val">$0</div><div className="hero-stat-lbl">IrrigationBossPro Extra User Fee</div></div>
        </div>
      </div>
          ...
          <div className="highlight-row">
            <div className="highlight-visual" style={{flex:1.5, minWidth:'280px'}}>
              ...
              <div className="sbp-contrast">
                <div className="sbp-contrast-label">IrrigationBossPro — $129/month, No Add-Ons</div>
            ...
            <div className="highlight-text" style={{flex:1, minWidth:'280px'}}>
              ...
              <h2>At the Same Price as CLIP Plus, IrrigationBossPro Has No Caps and 5 Features CLIP Doesn&apos;t Have at Any Price.</h2>
              <p>CLIP Plus is $129.99/month — a penny more than IrrigationBossPro — and it caps you at 400 properties and 2 users. Additional users are $20/month each. Payment processing is a separate add-on.</p>
              <p>IrrigationBossPro is $129/month with unlimited properties, unlimited users, payments included, lasso routing, sq ft waiting list, and chemical compliance logs. CLIP doesn&apos;t have any of those spray-specific features at any price tier.</p>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'960px', margin:'0 auto 48px'}}>
          ...
          <h2 className="section-title">IrrigationBossPro vs CLIP Lawn Software</h2>
          <p className="section-sub" style={{maxWidth:'720px', marginLeft:'auto', marginRight:'auto'}}>CLIP was designed for lawn maintenance and mowing. IrrigationBossPro was built for spray. Here&apos;s how the features compare.</p>
        </div>
      ...
      <div className="premium-band">
        <h2>At the Same Price as CLIP Plus, IrrigationBossPro Has No Caps and<span>5 Features CLIP Doesn&apos;t Have at Any Price.</span></h2>
        <p>CLIP Plus is $129.99/month. IrrigationBossPro is $129/month with unlimited properties, unlimited users, lasso routing, sq ft waiting list, chemical logs, and two-way SMS — none of which exist in CLIP. You pay less and get more, built specifically for spray businesses.</p>
      </div>

      <section>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto 56px'}}>
          <span className="section-label">Why It Matters</span>
          <h2 className="section-title">CLIP Was Built for Mowing. IrrigationBossPro Was Built for Spray.</h2>
      ...
      <div className="cta-band">
        <h2>Done Hitting Property Caps and Paying Per User?<span>IrrigationBossPro Is $129. Unlimited. Start Today.</span></h2>

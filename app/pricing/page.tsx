...
const faqs = [
  ...
  { q: 'Does this work for both lawn care and pest control?', a: 'Yes. IrrigationBossPro was built for spray businesses — lawn care, pest control, mosquito treatment, or any combination. The service types, chemical tracking, and waiting list work the same way regardless of what you spray.' },

  ...
  return (
    <>
      ...
      <div className="hero">
        ...
        <p>IrrigationBossPro is built specifically for lawn care and pest control. Every feature listed here is included in your $129/month — nothing locked, nothing extra.</p>
      ...
      <div className="spotlight">
        <div className="spotlight-inner">
          <div className="spotlight-text">
            ...
            <div className="spotlight-desc">On the waiting list map, draw a circle around any geographic area. IrrigationBossPro instantly shows you the total sq ft, linear ft, stop count, number of services, and a breakdown of every service type inside that circle — before you schedule a single stop.</div>
        ...
        <div className="cat-block">
          ...
          <div className="feat-grid">
            {[
              ...
              {t:'Treatment Count Tracking',d:'IrrigationBossPro counts down remaining applications automatically each time a service is marked complete.'},
            ].map((f,i) => (
              <div key={i} className="feat-item"><div className="feat-item-title">{f.t}</div><p>{f.d}</p></div>
            ))}
          </div>

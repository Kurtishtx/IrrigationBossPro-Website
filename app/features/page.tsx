  ...
  return (
    <>
      ...
      <div className="hero">
        ...
        <p>IrrigationBossPro is built specifically for irrigation and sprinkler companies. Every feature listed here is included in your from $59/month — nothing locked, nothing extra.</p>

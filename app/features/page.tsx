  ...
  return (
    <>
      ...
      <div className="hero">
        ...
        <h1>Everything You Need to Run<br /><span>Your Irrigation Business</span></h1>
        <p>IrrigationBossPro is built specifically for irrigation and sprinkler companies. Every feature listed here is included in your $129/month — nothing locked, nothing extra.</p>
      ...
      <div className="spotlight">
        <div className="spotlight-inner">
          <div className="spotlight-text">
            <div className="spotlight-label">Only in IrrigationBossPro</div>
            <div className="spotlight-title">Circle an Area on the Map.<br /><span>Instantly Know Everything Inside It.</span></div>
            <div className="spotlight-desc">On the job map, draw a circle around any neighborhood or zone. IrrigationBossPro instantly shows you the total properties, zone count, number of jobs, and a breakdown of every job type inside that circle — winterizations, start-ups, repairs, backflow tests — before you schedule a single stop.</div>
            <ul className="spotlight-checks">
              <li>Draw a lasso around any area on the map</li>
              <li>See total properties and zones for everything inside</li>
              <li>Total stops and total jobs in the selected area</li>
              <li>Breakdown by job type with totals for each</li>
              <li>Schedule all circled stops with one click</li>
              <li>They drop straight onto the dispatch board with a full route map</li>
              <li>No other irrigation or sprinkler software does this</li>
            </ul>
          </div>
          <div className="spotlight-visual">
            <div style={{color:'rgba(255,255,255,.5)',fontSize:'11px',textTransform:'uppercase',letterSpacing:'1px',marginBottom:'12px'}}>Job Map — Circle Selection</div>
            ...
            <div className="stat-row">
              ...
              <div className="stat-box"><div className="stat-val">114</div><div className="stat-lbl">Total Zones</div></div>
              <div className="stat-box"><div className="stat-val">14</div><div className="stat-lbl">Properties</div></div>
              <div className="stat-box wide"><div className="stat-val">Winterization · 8 &nbsp;|&nbsp; Repair · 6 &nbsp;|&nbsp; Backflow · 5</div><div className="stat-lbl">Jobs by Type</div></div>
            </div>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="cat-block">
          ...
          <div className="feat-grid">
            {[
              {t:'Job Board by Service Type',d:'See every job waiting for each service type before you build a route — installs, repairs, winterizations, start-ups, backflow tests. Know what you have before you make a call.'},
              {t:'Circle-to-Schedule Map Tool',d:'Draw a circle on the job map. Get instant totals — properties, zones, stops, jobs by type — then schedule them all at once.'},
              {t:'One-Click Schedule from Job Board',d:'Click any property and assign a date, crew, and truck in seconds. No extra screens, no copy-paste.'},
              {t:'Daily Dispatch Board',d:'All scheduled stops for any day in one view. Filter by crew, truck, or service. Print dispatch sheets for drivers.'},
              {t:'Crew & Truck Assignment',d:'Assign a crew and truck to every stop at scheduling time. Track who handled what and with which vehicle.'},
              ...
              {t:'Day Summary Bar',d:'Total stops, total jobs, and total revenue for the day shown at the top of the dispatch board at a glance.'},
              {t:'Full Service History per Property',d:'Every completed stop logged to the property record with date, crew, notes, and parts installed.'},
            ].map((f,i) => (
        ...
        <div className="cat-block">
          ...
          <div className="feat-grid">
            {[
              ...
              {t:'Color-Coded Status Pins',d:"Map pins update color as stops are completed or skipped — see your crews' progress in real time from the office."},
            ].map((f,i) => (
              <div key={i} className="feat-item"><div className="feat-item-title">{f.t}</div><p>{f.d}</p></div>
            ))}
          </div>
      ...
      <div className="dark-cat">
        <div className="cat-block" style={{maxWidth:'1200px',margin:'0 auto'}}>
          <div className="cat-header">
            <span className="cat-icon">🔧</span>
            <div><div className="cat-title">Parts &amp; Materials Tracking</div><div className="cat-desc">Every head, valve, controller, and foot of pipe logged to the job — and onto the invoice automatically</div></div>
          </div>
          <div className="feat-grid">
            {[
              {t:'Parts Log per Stop',d:'Heads, valves, controllers, pipe, fittings, and backflow devices logged on every completed job — automatically.'},
              {t:'Crew & Job Tracking',d:'Record which crew did the work and what they installed — a clean record of every part on every property.'},
              {t:'Parts Catalog with Pricing',d:'Build your parts library once. Crews select from your catalog in the field — no free-typing part names or prices.'},
              {t:'Job Type Logging',d:'Log job type — new install, valve repair, head replacement, backflow test, winterization — per stop for detailed records.'},
              {t:'Filter by Part, Property, Crew, or Date',d:'Pull any slice of your parts history instantly. Find every install of a specific part across all properties.'},
              {t:'Parts Flow Straight to the Invoice',d:'Parts logged in the field land on the invoice automatically — nothing installed gets left off the bill.'},
            ].map((f,i) => (
              <div key={i} className="feat-item"><div className="feat-item-title">{f.t}</div><p>{f.d}</p></div>
            ))}
          </div>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="cat-block">
          <div className="cat-header">
            <span className="cat-icon">💰</span>
            <div><div className="cat-title">Estimates</div><div className="cat-desc">Build, send, and close estimates without leaving IrrigationBossPro</div></div>
          </div>
          <div className="feat-grid">
            {[
              ...
              {t:'3-Step Automated Follow-Up',d:"3 follow-up texts go out automatically if a client doesn't respond. IrrigationBossPro chases the deal so you don't have to."},
              {t:'Discount Codes & Sales Tax',d:'Apply percentage or flat discounts. Set tax rates and IrrigationBossPro calculates tax on every estimate automatically.'},
      ...
      <div className="dark-cat">
        <div className="cat-block" style={{maxWidth:'1200px',margin:'0 auto'}}>
          ...
          <div className="feat-grid">
            {[
              {t:'Two-Way SMS Inbox',d:'Send and receive texts with customers inside IrrigationBossPro. Full conversation history organized by contact.'},
              ...
              {t:'Tech On the Way Alert',d:'Notify customers automatically when your crew is heading to their property.'},
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="cat-block">
          <div className="cat-header">
            <span className="cat-icon">🏠</span>
            <div><div className="cat-title">Clients, Leads &amp; Properties</div><div className="cat-desc">Full CRM built for irrigation businesses — everything tied to the address, not just the name</div></div>
          </div>
          <div className="feat-grid">
            {[
              ...
              {t:'Property Profiles',d:'Every address has its own record — zone count, controller location, GPS, photos, service history, parts log, and notes.'},
      ...
      <section>
        <div className="cat-block">
          <div className="cat-header">
            <span className="cat-icon">🍂</span>
            <div><div className="cat-title">Seasonal Service &amp; Renewals</div><div className="cat-desc">Manage recurring winterizations and spring start-ups and never miss a renewal</div></div>
          </div>
          <div className="feat-grid">
            {[
              {t:'Custom Service Plans',d:'Create any recurring plan — fall winterization, spring start-up, annual backflow test, seasonal tune-up. Fully custom service types and counts.'},
              {t:'Assign Clients to Plans',d:'Link any client to any plan. Track start date, visits used, and visits remaining automatically.'},
              {t:'Renewal Alerts',d:'Get alerted before a season rolls around so you can rebook winterizations and start-ups before the client looks elsewhere.'},
              {t:'Visit Count Tracking',d:'IrrigationBossPro counts down remaining seasonal visits automatically each time a service is marked complete.'},
            ].map((f,i) => (
              <div key={i} className="feat-item"><div className="feat-item-title">{f.t}</div><p>{f.d}</p></div>
            ))}
          </div>
        ...
        <div className="cat-block" style={{maxWidth:'1200px',margin:'0 auto'}}>
          ...
          <div className="feat-grid">
            {[
              ...
              {t:'Role-Based Permissions',d:'Owner, Manager, Office, Tech, and Mobile roles — each with different access levels built in.'},
        ...
        <div className="cat-block">
          ...
          <div className="feat-grid">
            {[
              ...
              {t:'Parts Log Entry',d:'Crews log the heads, valves, controllers, and pipe installed at each stop from their phone. Records are automatic.'},
              ...
              {t:'No App Download Required',d:"IrrigationBossPro's mobile experience runs in any browser. No app store, no install, no update prompts."},
            ].map((f,i) => (
              <div key={i} className="feat-item"><div className="feat-item-title">{f.t}</div><p>{f.d}</p></div>
            ))}
          </div>
        ...
        <div className="cat-block">
          ...
          <div className="feat-grid">
            {[
              ...
              {t:'Parts & Job Reports',d:'Pull a print-ready report of parts installed and jobs completed for any date range, part, property, or crew in seconds.'},
      ...
      <div id="sbp-form-1" style={{display:'none',position:'fixed',zIndex:99999,width:'420px',maxWidth:'calc(100vw - 24px)',background:'#fff',borderRadius:'14px',border:'3px solid #84cc16',boxShadow:'0 0 0 4px rgba(132,204,22,.35), 0 16px 60px rgba(0,0,0,.45)',maxHeight:'calc(100vh - 40px)',overflowY:'auto'}}>
        ...
        <div id="sbp1-step1" style={{padding:'24px 28px'}}>
          ...
          <div style={{marginBottom:'14px'}}><label style={{fontSize:'11px',fontWeight:700,color:'#555',textTransform:'uppercase',letterSpacing:'.5px',display:'block',marginBottom:'5px'}}>Company Name</label><input id="sbp1-company" type="text" placeholder="Smith Irrigation & Sprinkler Co." style={{width:'100%',border:'1px solid #ddd',borderRadius:'6px',padding:'10px 12px',fontSize:'14px',fontFamily:'inherit',color:'#333'}} /></div>
      ...
      <div id="sbp-form-2" style={{display:'none',position:'fixed',zIndex:99999,width:'420px',maxWidth:'calc(100vw - 24px)',background:'#fff',borderRadius:'14px',border:'3px solid #84cc16',boxShadow:'0 0 0 4px rgba(132,204,22,.35), 0 16px 60px rgba(0,0,0,.45)',maxHeight:'calc(100vh - 40px)',overflowY:'auto'}}>
        ...
        <div id="sbp2-step1" style={{padding:'24px 28px'}}>
          ...
          <div style={{marginBottom:'14px'}}><label style={{fontSize:'11px',fontWeight:700,color:'#555',textTransform:'uppercase',letterSpacing:'.5px',display:'block',marginBottom:'5px'}}>Company Name</label><input id="sbp2-company" type="text" placeholder="Smith Irrigation & Sprinkler Co." style={{width:'100%',border:'1px solid #ddd',borderRadius:'6px',padding:'10px 12px',fontSize:'14px',fontFamily:'inherit',color:'#333'}} /></div>

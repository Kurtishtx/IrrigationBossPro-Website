  ...
  return (
    <>
      ...
      <div className="hero">
        ...
        <p>Generic field service software wasn&apos;t built for pest control. IrrigationBossPro is — recurring treatment plans, chemical application logs, compliance reports, automated customer alerts, and route scheduling built around the way spray businesses actually operate.</p>
      ...
      <div style={{background:'var(--purple-dark)', padding:'0 40px 60px', textAlign:'center'}}>
        <img
          ...
          fetchPriority="high"
          decoding="async"
          alt="IrrigationBossPro pest control software showing recurring program scheduling, compliance logs, and mobile dispatch on laptop and phone"
      ...
      <section className="dark-section">
        <div className="highlight-row">
          <div className="highlight-text">
            ...
            <p style={{color:'rgba(255,255,255,.65)'}}>Lasso is the fastest way to build a pest control route we&apos;ve ever seen. Draw a circle on your service area map and IrrigationBossPro instantly pulls every property inside that radius that has a treatment due — with total stops, service types, and counts all calculated in real time before you commit to a single schedule. What used to take an hour now takes under five minutes.</p>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto 56px'}}>
          ...
          <p className="section-sub" style={{maxWidth:'720px'}}>Most powerful software is complicated. IrrigationBossPro is the exception. Every screen was designed by people who ran spray routes — not UX designers who&apos;ve never been near a service truck. Your team will be using it confidently on day one.</p>
        </div>
        <div style={{display:'grid', gridTemplateColumns:'repeat(auto-fit, minmax(240px, 1fr))', gap:'24px', maxWidth:'1100px', margin:'0 auto'}}>
          {[
            ...
            {n:'04', title:'Automation Runs Without You', body:'Set up your SMS alerts, estimate follow-ups, and payment reminders once. After that, IrrigationBossPro handles every notification, every follow-up text, and every review request automatically — whether you\'re on a route, at the office, or on a day off.'},
          ].map(({n, title, body}) => (
      ...
      <section style={{background:'var(--light-bg)'}}>
        ...
        <div style={{maxWidth:'900px', margin:'0 auto'}}>
          <div style={{background:'#fff', border:'1.5px solid var(--border)', borderRadius:'14px', padding:'36px 40px', borderLeft:'5px solid var(--orange)'}}>
            <p style={{fontSize:'17px', color:'var(--text)', lineHeight:1.8, marginBottom:'16px'}}>We ran our own routes for years before building IrrigationBossPro. We used every piece of software on the market — the big names, the field service apps, the ones that promised they &quot;work for any industry.&quot; None of them tracked chemicals the way regulators actually require. None of them had a waiting list that showed us how much work was ready before we built a route. None of them understood that a pest control business runs on recurring service, not one-off jobs.</p>
            <p style={{fontSize:'17px', color:'var(--text)', lineHeight:1.8, marginBottom:'16px'}}>We built IrrigationBossPro because we needed it. <strong>Every feature exists because someone on a real pest control route needed it.</strong> Not because a software company thought it sounded good.</p>
            <p style={{fontSize:'17px', color:'var(--text)', lineHeight:1.8}}>If you run mosquito treatments, general pest, rodent control, termite inspections, or any combination — IrrigationBossPro was built for the way you work.</p>
          </div>
        </div>
      </section>
      ...
      <section>
        <div className="centered" style={{maxWidth:'1200px', margin:'0 auto'}}>
          ...
          <p className="section-sub">From your first estimate to your compliance report at the end of the year — IrrigationBossPro covers the full lifecycle of a pest control business.</p>
        </div>
        <div className="feature-grid">
          {[
            ...
            {icon:'🔁', title:'Recurring Treatment Plans', body:'Set up quarterly, bi-monthly, or custom recurring schedules for any property. IrrigationBossPro tracks when each stop is due and flags it automatically — no spreadsheet, no calendar reminders.'},
            ...
            {icon:'💰', title:'Estimates & Proposals', body:'Build a pest control estimate in minutes, email it with one click, and let the client accept online. 3 automated follow-ups go out if they don\'t respond — IrrigationBossPro chases the deal for you.'},
            {icon:'💳', title:'Card-on-File Billing', body:'Store cards via Stripe. Charge after each treatment, send invoices, and let IrrigationBossPro send 3 automated payment reminders if an invoice goes unpaid. Stop chasing checks.'},
            ...
            {icon:'💬', title:'Two-Way SMS Inbox', body:'Customers text you, you text them — all inside IrrigationBossPro. Full conversation history by contact. No more mixing business texts with your personal phone.'},
            {icon:'📦', title:'Service Package Plans', body:'Create annual or multi-treatment packages, assign clients to them, and track how many treatments remain. IrrigationBossPro alerts you when a package is coming up for renewal.'},
            ...
            {icon:'🏷️', title:'Discounts & Sales Tax', body:'Apply percentage or flat discounts to any estimate. Set tax rates and IrrigationBossPro calculates and tracks tax on every invoice automatically.'},
          ].map(({icon, title, body}) => (
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="highlight-row">
          <div className="highlight-text">
            ...
            <p>Every state requires pesticide application records. IrrigationBossPro logs every application automatically when your tech marks a job complete — and you can pull a print-ready compliance report for any date range, product, technician, or property in under 30 seconds.</p>
      ...
      <section>
        <div className="highlight-row reverse">
          <div className="highlight-text">
            ...
            <p>Pest control runs on recurring revenue — and IrrigationBossPro is built around it. Set a schedule for any property, track how many treatments remain in a package, and let IrrigationBossPro alert you and the customer when it&apos;s time for the next visit. For a closer look at how package plan tracking drives renewal timing across a full book of recurring accounts, read <a href="/blogs/why-pest-control-software-recurring-treatments" style={{color:'var(--orange)', fontWeight:600}}>Why Pest Control Businesses Need Software Built for Recurring Treatments</a>.</p>
            <ul className="check-list">
      ...
      <section style={{background:'#fff'}}>
        <div style={{maxWidth:'860px', margin:'0 auto', padding:'80px 40px'}}>
          ...
          {[
            {q:'Does IrrigationBossPro work for pest control businesses?', a:'Yes. IrrigationBossPro is built for recurring pest control programs — quarterly, bi-monthly, monthly, and custom intervals. It handles route scheduling, chemical compliance logs, automated SMS alerts, estimate-to-program conversion, and card-on-file payments for recurring treatments.'},
            {q:'Can I manage quarterly, bi-monthly, and monthly programs at the same time?', a:'Yes. IrrigationBossPro supports multiple program intervals simultaneously. Each customer can be on a different schedule, and the waiting list tracks every account across all program types. When a treatment is completed, the next one is automatically placed back at the correct interval — no manual rebooking.'},
            ...
            {q:'Does IrrigationBossPro send automated SMS for pest control visits?', a:'Yes. Pre-built SMS alerts include appointment reminders, on-the-way notifications, service completion messages, and re-entry interval instructions. Alerts fire automatically from dispatch and completion events — configured once, sent on every job.'},
            {q:'Can I manage multiple pest control technicians?', a:'Yes. IrrigationBossPro supports unlimited technicians. The dispatch board assigns routes to specific technicians, and each uses the mobile app to see their stops, property notes, and chemical log form. No per-user fees regardless of crew size.'},
            {q:'How much does IrrigationBossPro cost for pest control?', a:'$129/month, flat. Every feature — route scheduling, compliance logs, SMS alerts, card payments — is included at one price. No per-user fees, no add-ons. 14-day free trial, no credit card required.'},
          ].map(({q, a}, i, arr) => (
          ...
          <p style={{marginTop:'40px', color:'var(--muted)', fontSize:'15px', lineHeight:1.7}}>IrrigationBossPro handles pest control alongside lawn care, mosquito spray, and every other spray service from one platform — <a href="/" style={{color:'var(--orange)', fontWeight:600}}>see the full platform overview</a>.</p>
        </div>
      </section>
      ...
      <div className="cta-band">
        ...
        <p>IrrigationBossPro is built by people who&apos;ve run real spray routes. Try it free for 14 days — no credit card required.</p>
        <div className="hero-btns">
